 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function K(t){var e,n;return"server_timestamp"===(null===(n=((null===(e=null==t?void 0:t.mapValue)||void 0===e?void 0:e.fields)||{}).__type__)||void 0===n?void 0:n.stringValue)}function Y(t){const e=t.mapValue.fields.__previous_value__;return K(e)?Y(e):e}function Q(t){const e=z(t.mapValue.fields.__local_write_time__.timestampValue);return new D(e.seconds,e.nanos)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(t,["next","error","complete"])}class Js extends Hs{constructor(t,e){super(t,e),this.type="firestore",this._queue=new Qs,this._persistenceKey="name"in t?t.name:"[DEFAULT]"}_terminate(){return this._firestoreClient||eo(this),this._firestoreClient.terminate()}}function Zs(t=Object(r["e"])()){return Object(r["b"])(t,"firestore").getImmediate()}function to(t){return t._firestoreClient||eo(t),t._firestoreClient.verifyNotTerminated(),t._firestoreClient}function eo(t){var e;const n=t._freezeSettings(),r=function(t,e,n,r){return new Ps(t,e,n,r.host,r.ssl,r.experimentalForceLongPolling,r.experimentalAutoDetectLongPolling,r.useFetchStreams)}(t._databaseId,(null===(e=t._app)||void 0===e?void 0:e.options.appId)||"",t._persistenceKey,n);t._firestoreClient=new Is(t._credentials,t._queue,r)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class so{constructor(t,e){if(!isFinite(t)||t<-90||t>90)throw new w(b.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+t);if(!isFinite(e)||e<-180||e>180)throw new w(b.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+e);this._lat=t,this._long=e}get latitude(){return this._lat}get longitude(){return this._long}isEqual(t){return this._lat===t._lat&&this._long===t._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(t){return N(this._lat,t._lat)||N(this._long,t._long)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xo{constructor(t,e,n,r,i){this._firestore=t,this._userDataWriter=e,this._key=n,this._document=r,this._converter=i}get id(){return this._key.path.lastSegment()}get ref(){return new zs(this._firestore,this._converter,this._key)}exists(){return null!==this._document}data(){if(this._document){if(this._converter){const t=new Ao(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(t)}return this._userDataWriter.convertValue(this._document.data.value)}}get(t){if(this._document){const e=this._document.data.field(Oo("DocumentSnapshot.get",t));if(null!==e)return this._userDataWriter.convertValue(e)}}}class Ao extends xo{data(){return super.data()}}function Oo(t,e){return"string"==typeof e?Io(t,e):e instanceof no?e._internalPath:e._delegate._internalPath}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class No{constructor(t,e){this.hasPendingWrites=t,this.fromCache=e}isEqual(t){return this.hasPendingWrites===t.hasPendingWrites&&this.fromCache===t.fromCache}}class Ro extends xo{constructor(t,e,n,r,i,s){super(t,e,n,r,s),this._firestore=t,this._firestoreImpl=t,this.metadata=i}exists(){return super.exists()}data(t={}){if(this._document){if(this._converter){const e=new Do(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(e,t)}return this._userDataWriter.convertValue(this._document.data.value,t.serverTimestamps)}}get(t,e={}){if(this._document){const n=this._document.data.field(Oo("DocumentSnapshot.get",t));if(null!==n)return this._userDataWriter.convertValue(n,e.serverTimestamps)}}}class Do extends Ro{data(t={}){return super.data(t)}}class Po{constructor(t,e,n,r){this._firestore=t,this._userDataWriter=e,this._snapshot=r,this.metadata=new No(r.hasPendingWrites,r.fromCache),this.query=n}get docs(){const t=[];return this.forEach(e=>t.push(e)),t}get size(){return this._snapshot.docs.size}get empty(){return 0===this.size}forEach(t,e){this._snapshot.docs.forEach(n=>{t.call(e,new Do(this._firestore,this._userDataWriter,n.key,n,new No(this._snapshot.mutatedKeys.has(n.key),this._snapshot.fromCache),this.query.converter))})}docChanges(t={}){const e=!!t.includeMetadataChanges;if(e&&this._snapshot.excludesMetadataChanges)throw new w(b.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===e||(this._cachedChanges=function(t,e){if(t._snapshot.oldDocs.isEmpty()){let e=0;return t._snapshot.docChanges.map(n=>({type:"added",doc:new Do(t._firestore,t._userDataWriter,n.doc.key,n.doc,new No(t._snapshot.mutatedKeys.has(n.doc.key),t._snapshot.fromCache),t.query.converter),oldIndex:-1,newIndex:e++}))}{let n=t._snapshot.oldDocs;return t._snapshot.docChanges.filter(t=>e||3!==t.type).map(e=>{const r=new Do(t._firestore,t._userDataWriter,e.doc.key,e.doc,new No(t._snapshot.mutatedKeys.has(e.doc.key),t._snapshot.fromCache),t.query.converter);let i=-1,s=-1;return 0!==e.type&&(i=n.indexOf(e.doc.key),n=n.delete(e.doc.key)),1!==e.type&&(n=n.add(e.doc),s=n.indexOf(e.doc.key)),{type:Lo(e.type),doc:r,oldIndex:i,newIndex:s}})}}(this,e),this._cachedChangesIncludeMetadataChanges=e),this._cachedChanges}}function Lo(t){switch(t){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return y()}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ho{convertValue(t,e="none"){switch(et(t)){case 0:return null;case 1:return t.booleanValue;case 2:return G(t.integerValue||t.doubleValue);case 3:return this.convertTimestamp(t.timestampValue);case 4:return this.convertServerTimestamp(t,e);case 5:return t.stringValue;case 6:return this.convertBytes(W(t.bytesValue));case 7:return this.convertReference(t.referenceValue);case 8:return this.convertGeoPoint(t.geoPointValue);case 9:return this.convertArray(t.arrayValue,e);case 10:return this.convertObject(t.mapValue,e);default:throw y()}}convertObject(t,e){const n={};return j(t.fields,(t,r)=>{n[t]=this.convertValue(r,e)}),n}convertGeoPoint(t){return new so(G(t.latitude),G(t.longitude))}convertArray(t,e){return(t.values||[]).map(t=>this.convertValue(t,e))}convertServerTimestamp(t,e){switch(e){case"previous":const n=Y(t);return null==n?null:this.convertValue(n,e);case"estimate":return this.convertTimestamp(Q(t));default:return null}}convertTimestamp(t){const e=z(t);return new D(e.seconds,e.nanos)}convertDocumentKey(t,e){const n=U.fromString(t);v(Hn(n));const r=new Ls(n.get(1),n.get(3)),i=new tt(n.popFirst(5));return r.isEqual(e)||p(`Document ${i} contains a document reference within a different database (${r.projectId}/${r.database}) which is not supported. It will be treated as a reference in the current database (${e.projectId}/${e.database}) instead.`),i}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Go(t){t=$s(t,zs);const e=$s(t.firestore,Js);return Rs(to(e),t._key).then(n=>Zo(e,t,n))}class Wo extends Ho{constructor(t){super(),this.firestore=t}convertBytes(t){return new ro(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new zs(this.firestore,null,e)}}function Ko(t){t=$s(t,Gs);const e=$s(t.firestore,Js),n=to(e),r=new Wo(e);return jo(t._query),Ds(n,t._query).then(n=>new Po(e,r,t,n))}function Yo(t,e,n,...r){t=$s(t,zs);const i=$s(t.firestore,Js),s=fo(i);let a;return a="string"==typeof(e=Object(o["m"])(e))||e instanceof no?yo(s,"updateDoc",t._key,e,n,r):mo(s,"updateDoc",t._key,e),Jo(i,[a.toMutation(t._key,be.exists(!0))])}function Qo(t,e){const n=$s(t.firestore,Js),r=Ys(t),i=zo(t.converter,e);return Jo(n,[po(fo(t.firestore),"addDoc",r._key,i,null!==t.converter,{}).toMutation(r._key,be.exists(!1))]).then(()=>r)}function Xo(t,...e){var n,r,i;t=Object(o["m"])(t);let s={includeMetadataChanges:!1},a=0;"object"!=typeof e[a]||Xs(e[a])||(s=e[a],a++);const c={includeMetadataChanges:s.includeMetadataChanges};if(Xs(e[a])){const t=e[a];e[a]=null===(n=t.next)||void 0===n?void 0:n.bind(t),e[a+1]=null===(r=t.error)||void 0===r?void 0:r.bind(t),e[a+2]=null===(i=t.complete)||void 0===i?void 0:i.bind(t)}let u,l,h;if(t instanceof zs)l=$s(t.firestore,Js),h=$t(t._key.path),u={next:n=>{e[a]&&e[a](Zo(l,t,n))},error:e[a+1],complete:e[a+2]};else{const n=$s(t,Gs);l=$s(n.firestore,Js),h=n._query;const r=new Wo(l);u={next:t=>{e[a]&&e[a](new Po(l,r,n,t))},error:e[a+1],complete:e[a+2]},jo(t._query)}return function(t,e,n,r){const i=new Ts(r),s=new Ki(e,i,n);return t.asyncQueue.enqueueAndForget(async()=>Bi(await Ns(t),s)),()=>{i.Xo(),t.asyncQueue.enqueueAndForget(async()=>Hi(await Ns(t),s))}}(to(l),h,c,u)}function Jo(t,e){return function(t,e){const n=new C;return t.asyncQueue.enqueueAndForget(async()=>is(await Os(t),e,n)),n.promise}(to(t),e)}function Zo(t,e,n){const r=n.docs.get(e._key),i=new Wo(t);return new Ro(t,i,e._key,r,new No(n.hasPendingWrites,n.fromCache),e.converter)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function D(t){return JSON.parse(t)}function P(t){return JSON.stringify(t)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const L=function(t){let e={},n={},r={},i="";try{const s=t.split(".");e=D(h(s[0])||""),n=D(h(s[1])||""),i=s[2],r=n["d"]||{},delete n["d"]}catch(s){}return{header:e,claims:n,data:r,signature:i}},j=function(t){const e=L(t),n=e.claims;return!!n&&"object"===typeof n&&n.hasOwnProperty("iat")},M=function(t){const e=L(t).claims;return"object"===typeof e&&!0===e["admin"]};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ve;class qe extends Ue{static get __EMPTY_NODE(){return Ve}static set __EMPTY_NODE(t){Ve=t}compare(t,e){return D(t.name,e.name)}isDefinedOn(t){throw Object(s["e"])("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(t,e){return!1}minPost(){return Fe.MIN}maxPost(){return new Fe(R,Ve)}makePost(t,e){return Object(s["d"])("string"===typeof t,"KeyIndex indexValue must always be a string."),new Fe(t,Ve)}toString(){return".key"}}const $e=new qe;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function We(t,e){return D(t.name,e.name)}function Ke(t,e){return D(t,e)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Do{constructor(t,e,n,r){this.eventType=t,this.eventRegistration=e,this.snapshot=n,this.prevName=r}getPath(){const t=this.snapshot.ref;return"value"===this.eventType?t._path:t.parent._path}getEventType(){return this.eventType}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.getPath().toString()+":"+this.eventType+":"+Object(s["G"])(this.snapshot.exportVal())}}class Po{constructor(t,e,n){this.eventRegistration=t,this.error=e,this.path=n}getPath(){return this.path}getEventType(){return"cancel"}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.path.toString()+":cancel"}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class jo{constructor(t,e,n,r){this._repo=t,this._path=e,this._queryParams=n,this._orderByCalled=r}get key(){return _e(this._path)?null:pe(this._path)}get ref(){return new Mo(this._repo,this._path)}get _queryIdentifier(){const t=jn(this._queryParams),e=j(t);return"{}"===e?"default":e}get _queryObject(){return jn(this._queryParams)}isEqual(t){if(t=Object(s["m"])(t),!(t instanceof jo))return!1;const e=this._repo===t._repo,n=we(this._path,t._path),r=this._queryIdentifier===t._queryIdentifier;return e&&n&&r}toJSON(){return this.toString()}toString(){return this._repo.toString()+ge(this._path)}}class Mo extends jo{constructor(t,e){super(t,e,new Dn,!1)}get parent(){const t=ye(this._path);return null===t?null:new Mo(this._repo,t)}get root(){let t=this;while(null!==t.parent)t=t.parent;return t}}class Fo{constructor(t,e,n){this._node=t,this.ref=e,this._index=n}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(t){const e=new ue(t),n=Vo(this.ref,t);return new Fo(this._node.getChild(e),n,an)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(t){if(this._node.isLeafNode())return!1;const e=this._node;return!!e.forEachChild(this._index,(e,n)=>t(new Fo(n,Vo(this.ref,e),an)))}hasChild(t){const e=new ue(t);return!this._node.getChild(e).isEmpty()}hasChildren(){return!this._node.isLeafNode()&&!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function Uo(t,e){return t=Object(s["m"])(t),t._checkNotDeleted("ref"),void 0!==e?Vo(t._root,e):t._root}function Vo(t,e){return t=Object(s["m"])(t),null===he(t._path)?Hs("child","path",e,!1):Bs("child","path",e,!1),new Mo(t._repo,ve(t._path,e))}function qo(t,e){t=Object(s["m"])(t),zs("push",t._path),qs("push",e,t._path,!0);const n=ro(t._repo),r=Tn(n),i=Vo(t,r),o=Vo(t,r);let a;return a=null!=e?$o(o,e).then(()=>o):Promise.resolve(o),i.then=a.then.bind(a),i.catch=a.then.bind(a,void 0),i}function $o(t,e){t=Object(s["m"])(t),zs("set",t._path),qs("set",e,t._path,!1);const n=new s["a"];return lo(t._repo,t._path,e,null,n.wrapCallback(()=>{})),n.promise}class Bo{constructor(t){this.callbackContext=t}respondsTo(t){return"value"===t}createEvent(t,e){const n=e._queryParams.getIndex();return new Do("value",this,new Fo(t.snapshotNode,new Mo(e._repo,e._path),n))}getEventRunner(t){return"cancel"===t.getEventType()?()=>this.callbackContext.onCancel(t.error):()=>this.callbackContext.onValue(t.snapshot,null)}createCancelEvent(t,e){return this.callbackContext.hasCancelCallback?new Po(this,t,e):null}matches(t){return t instanceof Bo&&(!t.callbackContext||!this.callbackContext||t.callbackContext.matches(this.callbackContext))}hasAnyCallback(){return null!==this.callbackContext}}class Ho{constructor(t,e){this.eventType=t,this.callbackContext=e}respondsTo(t){let e="children_added"===t?"child_added":t;return e="children_removed"===e?"child_removed":e,this.eventType===e}createCancelEvent(t,e){return this.callbackContext.hasCancelCallback?new Po(this,t,e):null}createEvent(t,e){Object(s["d"])(null!=t.childName,"Child events should have a childName.");const n=Vo(new Mo(e._repo,e._path),t.childName),r=e._queryParams.getIndex();return new Do(t.type,this,new Fo(t.snapshotNode,n,r),t.prevName)}getEventRunner(t){return"cancel"===t.getEventType()?()=>this.callbackContext.onCancel(t.error):()=>this.callbackContext.onValue(t.snapshot,t.prevName)}matches(t){return t instanceof Ho&&(this.eventType===t.eventType&&(!this.callbackContext||!t.callbackContext||this.callbackContext.matches(t.callbackContext)))}hasAnyCallback(){return!!this.callbackContext}}function zo(t,e,n,r,i){let s;if("object"===typeof r&&(s=void 0,i=r),"function"===typeof r&&(s=r),i&&i.onlyOnce){const e=n,r=(n,r)=>{po(t._repo,t,a),e(n,r)};r.userCallback=n.userCallback,r.context=n.context,n=r}const o=new Lo(n,s||void 0),a="value"===e?new Bo(o):new Ho(e,o);return fo(t._repo,t,a),()=>po(t._repo,t,a)}function Go(t,e,n,r){return zo(t,"value",e,n,r)}Si(Mo),Ui(Mo);
/**
 * @license
 * Copyright 2020 Google LLC
 *
