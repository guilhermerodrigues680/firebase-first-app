 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class T{constructor(t,e){this.user=e,this.type="OAuth",this.authHeaders={},this.authHeaders.Authorization="Bearer "+t}}class E{getToken(){return Promise.resolve(null)}invalidateToken(){}start(t,e){t.enqueueRetryable(()=>e(u.UNAUTHENTICATED))}shutdown(){}}class S{constructor(t){this.t=t,this.currentUser=u.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(t,e){let n=this.i;const r=t=>this.i!==n?(n=this.i,e(t)):Promise.resolve();let i=new C;this.o=()=>{this.i++,this.currentUser=this.u(),i.resolve(),i=new C,t.enqueueRetryable(()=>r(this.currentUser))};const s=()=>{const e=i;t.enqueueRetryable(async()=>{await e.promise,await r(this.currentUser)})},o=t=>{f("FirebaseCredentialsProvider","Auth detected"),this.auth=t,this.auth.addAuthTokenListener(this.o),s()};this.t.onInit(t=>o(t)),setTimeout(()=>{if(!this.auth){const t=this.t.getImmediate({optional:!0});t?o(t):(f("FirebaseCredentialsProvider","Auth not yet detected"),i.resolve(),i=new C)}},0),s()}getToken(){const t=this.i,e=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(e).then(e=>this.i!==t?(f("FirebaseCredentialsProvider","getToken aborted due to token change."),this.getToken()):e?(v("string"==typeof e.accessToken),new T(e.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.auth.removeAuthTokenListener(this.o)}u(){const t=this.auth&&this.auth.getUid();return v(null===t||"string"==typeof t),new u(t)}}class I{constructor(t,e,n){this.h=t,this.l=e,this.m=n,this.type="FirstParty",this.user=u.FIRST_PARTY}get authHeaders(){const t={"X-Goog-AuthUser":this.l},e=this.h.auth.getAuthHeaderValueForFirstParty([]);return e&&(t.Authorization=e),this.m&&(t["X-Goog-Iam-Authorization-Token"]=this.m),t}}class k{constructor(t,e,n){this.h=t,this.l=e,this.m=n}getToken(){return Promise.resolve(new I(this.h,this.l,this.m))}start(t,e){t.enqueueRetryable(()=>e(u.FIRST_PARTY))}shutdown(){}invalidateToken(){}}
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ${constructor(t){this.fields=t,t.sort(q.comparator)}covers(t){for(const e of this.fields)if(e.isPrefixOf(t))return!0;return!1}isEqual(t){return P(this.fields,t.fields,(t,e)=>t.isEqual(e))}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(t){return A(this.binaryString,t.binaryString)}isEqual(t){return this.binaryString===t.binaryString}}B.EMPTY_BYTE_STRING=new B("");const z=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function G(t){if(v(!!t),"string"==typeof t){let e=0;const n=z.exec(t);if(v(!!n),n[1]){let t=n[1];t=(t+"000000000").substr(0,9),e=Number(t)}const r=new Date(t);return{seconds:Math.floor(r.getTime()/1e3),nanos:e}}return{seconds:H(t.seconds),nanos:H(t.nanos)}}function H(t){return"number"==typeof t?t:"string"==typeof t?Number(t):0}function W(t){return"string"==typeof t?B.fromBase64String(t):B.fromUint8Array(t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function K(t){var e,n;return"server_timestamp"===(null===(n=((null===(e=null==t?void 0:t.mapValue)||void 0===e?void 0:e.fields)||{}).__type__)||void 0===n?void 0:n.stringValue)}function Y(t){const e=t.mapValue.fields.__previous_value__;return K(e)?Y(e):e}function Q(t){const e=G(t.mapValue.fields.__local_write_time__.timestampValue);return new N(e.seconds,e.nanos)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oe{constructor(){this._=void 0}}function ae(t,e,n){return t instanceof le?function(t,e){const n={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:t.seconds,nanos:t.nanoseconds}}}};return e&&(n.fields.__previous_value__=e),{mapValue:n}}(n,e):t instanceof he?de(t,e):t instanceof fe?pe(t,e):function(t,e){const n=ue(t,e),r=ge(n)+ge(t.C);return ut(n)&&ut(t.C)?ie(r):re(t.N,r)}(t,e)}function ce(t,e,n){return t instanceof he?de(t,e):t instanceof fe?pe(t,e):n}function ue(t,e){return t instanceof me?ut(n=e)||function(t){return!!t&&"doubleValue"in t}(n)?e:{integerValue:0}:null;var n}class le extends oe{}class he extends oe{constructor(t){super(),this.elements=t}}function de(t,e){const n=ye(e);for(const r of t.elements)n.some(t=>nt(t,r))||n.push(r);return{arrayValue:{values:n}}}class fe extends oe{constructor(t){super(),this.elements=t}}function pe(t,e){let n=ye(e);for(const r of t.elements)n=n.filter(t=>!nt(t,r));return{arrayValue:{values:n}}}class me extends oe{constructor(t,e){super(),this.N=t,this.C=e}}function ge(t){return H(t.integerValue||t.doubleValue)}function ye(t){return lt(t)&&t.arrayValue.values?t.arrayValue.values.slice():[]}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ve(t,e){return t.field.isEqual(e.field)&&function(t,e){return t instanceof he&&e instanceof he||t instanceof fe&&e instanceof fe?P(t.elements,e.elements,nt):t instanceof me&&e instanceof me?nt(t.C,e.C):t instanceof le&&e instanceof le}(t.transform,e.transform)}class _e{constructor(t,e){this.version=t,this.transformResults=e}}class be{constructor(t,e){this.updateTime=t,this.exists=e}static none(){return new be}static exists(t){return new be(void 0,t)}static updateTime(t){return new be(t)}get isNone(){return void 0===this.updateTime&&void 0===this.exists}isEqual(t){return this.exists===t.exists&&(this.updateTime?!!t.updateTime&&this.updateTime.isEqual(t.updateTime):!t.updateTime)}}function we(t,e){return void 0!==t.updateTime?e.isFoundDocument()&&e.version.isEqual(t.updateTime):void 0===t.exists||t.exists===e.isFoundDocument()}class Ce{}function Te(t,e,n){t instanceof xe?function(t,e,n){const r=t.value.clone(),i=Ae(t.fieldTransforms,e,n.transformResults);r.setAll(i),e.convertToFoundDocument(n.version,r).setHasCommittedMutations()}(t,e,n):t instanceof Re?function(t,e,n){if(!we(t.precondition,e))return void e.convertToUnknownDocument(n.version);const r=Ae(t.fieldTransforms,e,n.transformResults),i=e.data;i.setAll(Oe(t)),i.setAll(r),e.convertToFoundDocument(n.version,i).setHasCommittedMutations()}(t,e,n):function(t,e,n){e.convertToNoDocument(n.version).setHasCommittedMutations()}(0,e,n)}function Ee(t,e,n){t instanceof xe?function(t,e,n){if(!we(t.precondition,e))return;const r=t.value.clone(),i=Pe(t.fieldTransforms,n,e);r.setAll(i),e.convertToFoundDocument(ke(e),r).setHasLocalMutations()}(t,e,n):t instanceof Re?function(t,e,n){if(!we(t.precondition,e))return;const r=Pe(t.fieldTransforms,n,e),i=e.data;i.setAll(Oe(t)),i.setAll(r),e.convertToFoundDocument(ke(e),i).setHasLocalMutations()}(t,e,n):function(t,e){we(t.precondition,e)&&e.convertToNoDocument(D.min())}(t,e)}function Se(t,e){let n=null;for(const r of t.fieldTransforms){const t=e.data.field(r.field),i=ue(r.transform,t||null);null!=i&&(null==n&&(n=mt.empty()),n.set(r.field,i))}return n||null}function Ie(t,e){return t.type===e.type&&!!t.key.isEqual(e.key)&&!!t.precondition.isEqual(e.precondition)&&!!function(t,e){return void 0===t&&void 0===e||!(!t||!e)&&P(t,e,(t,e)=>ve(t,e))}(t.fieldTransforms,e.fieldTransforms)&&(0===t.type?t.value.isEqual(e.value):1!==t.type||t.data.isEqual(e.data)&&t.fieldMask.isEqual(e.fieldMask))}function ke(t){return t.isFoundDocument()?t.version:D.min()}class xe extends Ce{constructor(t,e,n,r=[]){super(),this.key=t,this.value=e,this.precondition=n,this.fieldTransforms=r,this.type=0}}class Re extends Ce{constructor(t,e,n,r,i=[]){super(),this.key=t,this.data=e,this.fieldMask=n,this.precondition=r,this.fieldTransforms=i,this.type=1}}function Oe(t){const e=new Map;return t.fieldMask.fields.forEach(n=>{if(!n.isEmpty()){const r=t.data.field(n);e.set(n,r)}}),e}function Ae(t,e,n){const r=new Map;v(t.length===n.length);for(let i=0;i<n.length;i++){const s=t[i],o=s.transform,a=e.data.field(s.field);r.set(s.field,ce(o,a,n[i]))}return r}function Pe(t,e,n){const r=new Map;for(const i of t){const t=i.transform,s=n.data.field(i.field);r.set(i.field,ae(t,s,e))}return r}class Ne extends Ce{constructor(t,e){super(),this.key=t,this.precondition=e,this.type=2,this.fieldTransforms=[]}}class De extends Ce{constructor(t,e){super(),this.key=t,this.precondition=e,this.type=3,this.fieldTransforms=[]}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Be{constructor(t){this.comparator=t,this.data=new Ve(this.comparator)}has(t){return null!==this.data.get(t)}first(){return this.data.minKey()}last(){return this.data.maxKey()}get size(){return this.data.size}indexOf(t){return this.data.indexOf(t)}forEach(t){this.data.inorderTraversal((e,n)=>(t(e),!1))}forEachInRange(t,e){const n=this.data.getIteratorFrom(t[0]);for(;n.hasNext();){const r=n.getNext();if(this.comparator(r.key,t[1])>=0)return;e(r.key)}}forEachWhile(t,e){let n;for(n=void 0!==e?this.data.getIteratorFrom(e):this.data.getIterator();n.hasNext();)if(!t(n.getNext().key))return}firstAfterOrEqual(t){const e=this.data.getIteratorFrom(t);return e.hasNext()?e.getNext().key:null}getIterator(){return new ze(this.data.getIterator())}getIteratorFrom(t){return new ze(this.data.getIteratorFrom(t))}add(t){return this.copy(this.data.remove(t).insert(t,!0))}delete(t){return this.has(t)?this.copy(this.data.remove(t)):this}isEmpty(){return this.data.isEmpty()}unionWith(t){let e=this;return e.size<t.size&&(e=t,t=this),t.forEach(t=>{e=e.add(t)}),e}isEqual(t){if(!(t instanceof Be))return!1;if(this.size!==t.size)return!1;const e=this.data.getIterator(),n=t.data.getIterator();for(;e.hasNext();){const t=e.getNext().key,r=n.getNext().key;if(0!==this.comparator(t,r))return!1}return!0}toArray(){const t=[];return this.forEach(e=>{t.push(e)}),t}toString(){const t=[];return this.forEach(e=>t.push(e)),"SortedSet("+t.toString()+")"}copy(t){const e=new Be(this.comparator);return e.data=t,e}}class ze{constructor(t){this.iter=t}getNext(){return this.iter.getNext().key}hasNext(){return this.iter.hasNext()}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ge=new Ve(tt.comparator);function He(){return Ge}const We=new Ve(tt.comparator);function Ke(){return We}const Ye=new Ve(tt.comparator);function Qe(){return Ye}const Xe=new Be(tt.comparator);function Je(...t){let e=Xe;for(const n of t)e=e.add(n);return e}const Ze=new Be(A);function tn(){return Ze}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pr{constructor(t){this.Wt=t}}function mr(t){const e=Pn({parent:t.parent,structuredQuery:t.structuredQuery});return"LAST"===t.limitType?Qt(e,e.limit,"L"):e}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zr{constructor(t,e){this.bs={},this.Le=new x(0),this.Be=!1,this.Be=!0,this.referenceDelegate=t(this),this.ze=new Br(this),this.Ht=new gr,this.He=function(t,e){return new qr(t,e)}(this.Ht,t=>this.referenceDelegate.Ps(t)),this.N=new pr(e),this.Je=new Mr(this.N)}start(){return Promise.resolve()}shutdown(){return this.Be=!1,Promise.resolve()}get started(){return this.Be}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(){return this.Ht}getMutationQueue(t){let e=this.bs[t.toKey()];return e||(e=new Vr(this.Ht,this.referenceDelegate),this.bs[t.toKey()]=e),e}getTargetCache(){return this.ze}getRemoteDocumentCache(){return this.He}getBundleCache(){return this.Je}runTransaction(t,e,n){f("MemoryPersistence","Starting transaction:",t);const r=new Gr(this.Le.next());return this.referenceDelegate.vs(),n(r).next(t=>this.referenceDelegate.Vs(r).next(()=>t)).toPromise().then(t=>(r.raiseOnCommittedEvent(),t))}Ss(t,e){return ur.or(Object.values(this.bs).map(n=>()=>n.containsKey(t,e)))}}class Gr extends cr{constructor(t){super(),this.currentSequenceNumber=t}}class Hr{constructor(t){this.persistence=t,this.Ds=new Fr,this.Cs=null}static Ns(t){return new Hr(t)}get xs(){if(this.Cs)return this.Cs;throw y()}addReference(t,e,n){return this.Ds.addReference(n,e),this.xs.delete(n.toString()),ur.resolve()}removeReference(t,e,n){return this.Ds.removeReference(n,e),this.xs.add(n.toString()),ur.resolve()}markPotentiallyOrphaned(t,e){return this.xs.add(e.toString()),ur.resolve()}removeTarget(t,e){this.Ds.cs(e.targetId).forEach(t=>this.xs.add(t.toString()));const n=this.persistence.getTargetCache();return n.getMatchingKeysForTargetId(t,e.targetId).next(t=>{t.forEach(t=>this.xs.add(t.toString()))}).next(()=>n.removeTargetData(t,e))}vs(){this.Cs=new Set}Vs(t){const e=this.persistence.getRemoteDocumentCache().newChangeBuffer();return ur.forEach(this.xs,n=>{const r=tt.fromPath(n);return this.ks(t,r).next(t=>{t||e.removeEntry(r)})}).next(()=>(this.Cs=null,e.apply(t)))}updateLimboDocument(t,e){return this.ks(t,e).next(t=>{t?this.xs.delete(e.toString()):this.xs.add(e.toString())})}Ps(t){return 0}ks(t,e){return ur.or([()=>ur.resolve(this.Ds.containsKey(e)),()=>this.persistence.getTargetCache().containsKey(t,e),()=>this.persistence.Ss(t,e)])}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ci{constructor(t,e,n,r,i){this.localStore=t,this.datastore=e,this.asyncQueue=n,this.remoteSyncer={},this.Ur=[],this.qr=new Map,this.Kr=new Set,this.jr=[],this.Qr=i,this.Qr.Ti(t=>{n.enqueueAndForget(async()=>{yi(this)&&(f("RemoteStore","Restarting streams for network reachability change."),await async function(t){const e=_(t);e.Kr.add(4),await li(e),e.Wr.set("Unknown"),e.Kr.delete(4),await ui(e)}(this))})}),this.Wr=new ai(n,r)}}async function ui(t){if(yi(t))for(const e of t.jr)await e(!0)}async function li(t){for(const e of t.jr)await e(!1)}function hi(t,e){const n=_(t);n.qr.has(e.targetId)||(n.qr.set(e.targetId,e),gi(n)?mi(n):Di(n).cr()&&fi(n,e))}function di(t,e){const n=_(t),r=Di(n);n.qr.delete(e),r.cr()&&pi(n,e),0===n.qr.size&&(r.cr()?r.lr():yi(n)&&n.Wr.set("Unknown"))}function fi(t,e){t.Gr.Y(e.targetId),Di(t).Ir(e)}function pi(t,e){t.Gr.Y(e),Di(t).Ar(e)}function mi(t){t.Gr=new cn({getRemoteKeysForTarget:e=>t.remoteSyncer.getRemoteKeysForTarget(e),Tt:e=>t.qr.get(e)||null}),Di(t).start(),t.Wr.Or()}function gi(t){return yi(t)&&!Di(t).ar()&&t.qr.size>0}function yi(t){return 0===_(t).Kr.size}function vi(t){t.Gr=void 0}async function _i(t){t.qr.forEach((e,n)=>{fi(t,e)})}async function bi(t,e){vi(t),gi(t)?(t.Wr.Lr(e),mi(t)):t.Wr.set("Unknown")}async function wi(t,e,n){if(t.Wr.set("Online"),e instanceof on&&2===e.state&&e.cause)try{await async function(t,e){const n=e.cause;for(const r of e.targetIds)t.qr.has(r)&&(await t.remoteSyncer.rejectListen(r,n),t.qr.delete(r),t.Gr.removeTarget(r))}(t,e)}catch(n){f("RemoteStore","Failed to remove targets %s: %s ",e.targetIds.join(","),n),await Ci(t,n)}else if(e instanceof rn?t.Gr.rt(e):e instanceof sn?t.Gr.ft(e):t.Gr.ct(e),!n.isEqual(D.min()))try{const e=await Or(t.localStore);n.compareTo(e)>=0&&await function(t,e){const n=t.Gr._t(e);return n.targetChanges.forEach((n,r)=>{if(n.resumeToken.approximateByteSize()>0){const i=t.qr.get(r);i&&t.qr.set(r,i.withResumeToken(n.resumeToken,e))}}),n.targetMismatches.forEach(e=>{const n=t.qr.get(e);if(!n)return;t.qr.set(e,n.withResumeToken(B.EMPTY_BYTE_STRING,n.snapshotVersion)),pi(t,e);const r=new fr(n.target,e,1,n.sequenceNumber);fi(t,r)}),t.remoteSyncer.applyRemoteEvent(n)}(t,n)}catch(e){f("RemoteStore","Failed to raise snapshot:",e),await Ci(t,e)}}async function Ci(t,e,n){if(!lr(e))throw e;t.Kr.add(1),await li(t),t.Wr.set("Offline"),n||(n=()=>Or(t.localStore)),t.asyncQueue.enqueueRetryable(async()=>{f("RemoteStore","Retrying IndexedDB access"),await n(),t.Kr.delete(1),await ui(t)})}function Ti(t,e){return e().catch(n=>Ci(t,n,e))}async function Ei(t){const e=_(t),n=Li(e);let r=e.Ur.length>0?e.Ur[e.Ur.length-1].batchId:-1;for(;Si(e);)try{const t=await Nr(e.localStore,r);if(null===t){0===e.Ur.length&&n.lr();break}r=t.batchId,Ii(e,t)}catch(t){await Ci(e,t)}ki(e)&&xi(e)}function Si(t){return yi(t)&&t.Ur.length<10}function Ii(t,e){t.Ur.push(e);const n=Li(t);n.cr()&&n.br&&n.Pr(e.mutations)}function ki(t){return yi(t)&&!Li(t).ar()&&t.Ur.length>0}function xi(t){Li(t).start()}async function Ri(t){Li(t).Sr()}async function Oi(t){const e=Li(t);for(const n of t.Ur)e.Pr(n.mutations)}async function Ai(t,e,n){const r=t.Ur.shift(),i=dr.from(r,e,n);await Ti(t,()=>t.remoteSyncer.applySuccessfulWrite(i)),await Ei(t)}async function Pi(t,e){e&&Li(t).br&&await async function(t,e){if(n=e.code,Fe(n)&&n!==b.ABORTED){const n=t.Ur.shift();Li(t).hr(),await Ti(t,()=>t.remoteSyncer.rejectFailedWrite(n.batchId,e)),await Ei(t)}var n}(t,e),ki(t)&&xi(t)}async function Ni(t,e){const n=_(t);e?(n.Kr.delete(2),await ui(n)):e||(n.Kr.add(2),await li(n),n.Wr.set("Unknown"))}function Di(t){return t.zr||(t.zr=function(t,e,n){const r=_(t);return r.Cr(),new ii(e,r.nr,r.credentials,r.N,n)
/**
 * @license
 * Copyright 2018 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */}(t.datastore,t.asyncQueue,{Si:_i.bind(null,t),Ci:bi.bind(null,t),Er:wi.bind(null,t)}),t.jr.push(async e=>{e?(t.zr.hr(),gi(t)?mi(t):t.Wr.set("Unknown")):(await t.zr.stop(),vi(t))})),t.zr}function Li(t){return t.Hr||(t.Hr=function(t,e,n){const r=_(t);return r.Cr(),new si(e,r.nr,r.credentials,r.N,n)}(t.datastore,t.asyncQueue,{Si:Ri.bind(null,t),Ci:Pi.bind(null,t),Vr:Oi.bind(null,t),vr:Ai.bind(null,t)}),t.jr.push(async e=>{e?(t.Hr.hr(),await Ei(t)):(await t.Hr.stop(),t.Ur.length>0&&(f("RemoteStore",`Stopping write stream with ${t.Ur.length} pending writes`),t.Ur=[]))})),t.Hr
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Yi{constructor(t){this.key=t}}class Qi{constructor(t){this.key=t}}class Xi{constructor(t,e){this.query=t,this._o=e,this.mo=null,this.current=!1,this.yo=Je(),this.mutatedKeys=Je(),this.po=ee(t),this.To=new Fi(this.po)}get Eo(){return this._o}Io(t,e){const n=e?e.Ao:new Ui,r=e?e.To:this.To;let i=e?e.mutatedKeys:this.mutatedKeys,s=r,o=!1;const a=Bt(this.query)&&r.size===this.query.limit?r.last():null,c=zt(this.query)&&r.size===this.query.limit?r.first():null;if(t.inorderTraversal((t,e)=>{const u=r.get(t),l=te(this.query,e)?e:null,h=!!u&&this.mutatedKeys.has(u.key),d=!!l&&(l.hasLocalMutations||this.mutatedKeys.has(l.key)&&l.hasCommittedMutations);let f=!1;u&&l?u.data.isEqual(l.data)?h!==d&&(n.track({type:3,doc:l}),f=!0):this.Ro(u,l)||(n.track({type:2,doc:l}),f=!0,(a&&this.po(l,a)>0||c&&this.po(l,c)<0)&&(o=!0)):!u&&l?(n.track({type:0,doc:l}),f=!0):u&&!l&&(n.track({type:1,doc:u}),f=!0,(a||c)&&(o=!0)),f&&(l?(s=s.add(l),i=d?i.add(t):i.delete(t)):(s=s.delete(t),i=i.delete(t)))}),Bt(this.query)||zt(this.query))for(;s.size>this.query.limit;){const t=Bt(this.query)?s.last():s.first();s=s.delete(t.key),i=i.delete(t.key),n.track({type:1,doc:t})}return{To:s,Ao:n,Ln:o,mutatedKeys:i}}Ro(t,e){return t.hasLocalMutations&&e.hasCommittedMutations&&!e.hasLocalMutations}applyChanges(t,e,n){const r=this.To;this.To=t.To,this.mutatedKeys=t.mutatedKeys;const i=t.Ao.Yr();i.sort((t,e)=>function(t,e){const n=t=>{switch(t){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return y()}};return n(t)-n(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Gs{constructor(t,e,n){this.converter=e,this._key=n,this.type="document",this.firestore=t}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Ws(this.firestore,this.converter,this._key.path.popLast())}withConverter(t){return new Gs(this.firestore,t,this._key)}}class Hs{constructor(t,e,n){this.converter=e,this._query=n,this.type="query",this.firestore=t}withConverter(t){return new Hs(this.firestore,t,this._query)}}class Ws extends Hs{constructor(t,e,n){super(t,e,$t(n)),this._path=n,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const t=this._path.popLast();return t.isEmpty()?null:new Gs(this.firestore,null,new tt(t))}withConverter(t){return new Ws(this.firestore,t,this._path)}}function Ks(t,e,...n){if(t=Object(o["m"])(t),Ms("collection","path",e),t instanceof zs){const r=U.fromString(e,...n);return Vs(r),new Ws(t,null,r)}{if(!(t instanceof Gs||t instanceof Ws))throw new w(b.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=t._path.child(U.fromString(e,...n));return Vs(r),new Ws(t.firestore,null,r)}}function Ys(t,e,...n){if(t=Object(o["m"])(t),1===arguments.length&&(e=O.I()),Ms("doc","path",e),t instanceof zs){const r=U.fromString(e,...n);return Us(r),new Gs(t,null,new tt(r))}{if(!(t instanceof Gs||t instanceof Ws))throw new w(b.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=t._path.child(U.fromString(e,...n));return Us(r),new Gs(t.firestore,t instanceof Ws?t.converter:null,new tt(r))}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(t,["next","error","complete"])}class Js extends zs{constructor(t,e){super(t,e),this.type="firestore",this._queue=new Qs,this._persistenceKey="name"in t?t.name:"[DEFAULT]"}_terminate(){return this._firestoreClient||eo(this),this._firestoreClient.terminate()}}function Zs(t=Object(r["e"])()){return Object(r["b"])(t,"firestore").getImmediate()}function to(t){return t._firestoreClient||eo(t),t._firestoreClient.verifyNotTerminated(),t._firestoreClient}function eo(t){var e;const n=t._freezeSettings(),r=function(t,e,n,r){return new Ds(t,e,n,r.host,r.ssl,r.experimentalForceLongPolling,r.experimentalAutoDetectLongPolling,r.useFetchStreams)}(t._databaseId,(null===(e=t._app)||void 0===e?void 0:e.options.appId)||"",t._persistenceKey,n);t._firestoreClient=new Ss(t._credentials,t._queue,r)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class no{constructor(...t){for(let e=0;e<t.length;++e)if(0===t[e].length)throw new w(b.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new q(t)}isEqual(t){return this._internalPath.isEqual(t._internalPath)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class ro{constructor(t){this._byteString=t}static fromBase64String(t){try{return new ro(B.fromBase64String(t))}catch(t){throw new w(b.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(t){return new ro(B.fromUint8Array(t))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(t){return this._byteString.isEqual(t._byteString)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class so{constructor(t,e){if(!isFinite(t)||t<-90||t>90)throw new w(b.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+t);if(!isFinite(e)||e<-180||e>180)throw new w(b.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+e);this._lat=t,this._long=e}get latitude(){return this._lat}get longitude(){return this._long}isEqual(t){return this._lat===t._lat&&this._long===t._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(t){return A(this._lat,t._lat)||A(this._long,t._long)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const oo=/^__.*__$/;class ao{constructor(t,e,n){this.data=t,this.fieldMask=e,this.fieldTransforms=n}toMutation(t,e){return null!==this.fieldMask?new Re(t,this.data,this.fieldMask,e,this.fieldTransforms):new xe(t,this.data,e,this.fieldTransforms)}}class co{constructor(t,e,n){this.data=t,this.fieldMask=e,this.fieldTransforms=n}toMutation(t,e){return new Re(t,this.data,this.fieldMask,e,this.fieldTransforms)}}function uo(t){switch(t){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw y()}}class lo{constructor(t,e,n,r,i,s){this.settings=t,this.databaseId=e,this.N=n,this.ignoreUndefinedProperties=r,void 0===i&&this.Sa(),this.fieldTransforms=i||[],this.fieldMask=s||[]}get path(){return this.settings.path}get Da(){return this.settings.Da}Ca(t){return new lo(Object.assign(Object.assign({},this.settings),t),this.databaseId,this.N,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}Na(t){var e;const n=null===(e=this.path)||void 0===e?void 0:e.child(t),r=this.Ca({path:n,xa:!1});return r.ka(t),r}$a(t){var e;const n=null===(e=this.path)||void 0===e?void 0:e.child(t),r=this.Ca({path:n,xa:!1});return r.Sa(),r}Oa(t){return this.Ca({path:void 0,xa:!0})}Fa(t){return Io(t,this.settings.methodName,this.settings.Ma||!1,this.path,this.settings.La)}contains(t){return void 0!==this.fieldMask.find(e=>t.isPrefixOf(e))||void 0!==this.fieldTransforms.find(e=>t.isPrefixOf(e.field))}Sa(){if(this.path)for(let t=0;t<this.path.length;t++)this.ka(this.path.get(t))}ka(t){if(0===t.length)throw this.Fa("Document fields must not be empty");if(uo(this.Da)&&oo.test(t))throw this.Fa('Document fields cannot begin and end with "__"')}}class ho{constructor(t,e,n){this.databaseId=t,this.ignoreUndefinedProperties=e,this.N=n||ei(t)}Ba(t,e,n,r=!1){return new lo({Da:t,methodName:e,La:n,path:q.emptyPath(),xa:!1,Ma:r},this.databaseId,this.N,this.ignoreUndefinedProperties)}}function fo(t){const e=t._freezeSettings(),n=ei(t._databaseId);return new ho(t._databaseId,!!e.ignoreUndefinedProperties,n)}function po(t,e,n,r,i,s={}){const o=t.Ba(s.merge||s.mergeFields?2:0,e,n,i);Co("Data must be an object, but it was:",o,r);const a=bo(r,o);let c,u;if(s.merge)c=new $(o.fieldMask),u=o.fieldTransforms;else if(s.mergeFields){const t=[];for(const r of s.mergeFields){const i=To(e,r,n);if(!o.contains(i))throw new w(b.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);ko(t,i)||t.push(i)}c=new $(t),u=o.fieldTransforms.filter(t=>c.covers(t.field))}else c=null,u=o.fieldTransforms;return new ao(new mt(a),c,u)}class mo extends io{_toFieldTransform(t){if(2!==t.Da)throw 1===t.Da?t.Fa(this._methodName+"() can only appear at the top level of your update data"):t.Fa(this._methodName+"() cannot be used with set() unless you pass {merge:true}");return t.fieldMask.push(t.path),null}isEqual(t){return t instanceof mo}}function go(t,e,n,r){const i=t.Ba(1,e,n);Co("Data must be an object, but it was:",i,r);const s=[],a=mt.empty();j(r,(t,r)=>{const c=So(e,t,n);r=Object(o["m"])(r);const u=i.$a(c);if(r instanceof mo)s.push(c);else{const t=_o(r,u);null!=t&&(s.push(c),a.set(c,t))}});const c=new $(s);return new co(a,c,i.fieldTransforms)}function yo(t,e,n,r,i,s){const a=t.Ba(1,e,n),c=[To(e,r,n)],u=[i];if(s.length%2!=0)throw new w(b.INVALID_ARGUMENT,`Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let o=0;o<s.length;o+=2)c.push(To(e,s[o])),u.push(s[o+1]);const l=[],h=mt.empty();for(let f=c.length-1;f>=0;--f)if(!ko(l,c[f])){const t=c[f];let e=u[f];e=Object(o["m"])(e);const n=a.$a(t);if(e instanceof mo)l.push(t);else{const r=_o(e,n);null!=r&&(l.push(t),h.set(t,r))}}const d=new $(l);return new co(h,d,a.fieldTransforms)}function vo(t,e,n,r=!1){return _o(n,t.Ba(r?4:3,e))}function _o(t,e){if(wo(t=Object(o["m"])(t)))return Co("Unsupported field value:",e,t),bo(t,e);if(t instanceof io)return function(t,e){if(!uo(e.Da))throw e.Fa(t._methodName+"() can only be used with update() and set()");if(!e.path)throw e.Fa(t._methodName+"() is not currently supported inside arrays");const n=t._toFieldTransform(e);n&&e.fieldTransforms.push(n)}(t,e),null;if(void 0===t&&e.ignoreUndefinedProperties)return null;if(e.path&&e.fieldMask.push(e.path),t instanceof Array){if(e.settings.xa&&4!==e.Da)throw e.Fa("Nested arrays are not supported");return function(t,e){const n=[];let r=0;for(const i of t){let t=_o(i,e.Oa(r));null==t&&(t={nullValue:"NULL_VALUE"}),n.push(t),r++}return{arrayValue:{values:n}}}(t,e)}return function(t,e){if(null===(t=Object(o["m"])(t)))return{nullValue:"NULL_VALUE"};if("number"==typeof t)return se(e.N,t);if("boolean"==typeof t)return{booleanValue:t};if("string"==typeof t)return{stringValue:t};if(t instanceof Date){const n=N.fromDate(t);return{timestampValue:pn(e.N,n)}}if(t instanceof N){const n=new N(t.seconds,1e3*Math.floor(t.nanoseconds/1e3));return{timestampValue:pn(e.N,n)}}if(t instanceof so)return{geoPointValue:{latitude:t.latitude,longitude:t.longitude}};if(t instanceof ro)return{bytesValue:mn(e.N,t._byteString)};if(t instanceof Gs){const n=e.databaseId,r=t.firestore._databaseId;if(!r.isEqual(n))throw e.Fa(`Document reference is for database ${r.projectId}/${r.database} but should be for database ${n.projectId}/${n.database}`);return{referenceValue:vn(t.firestore._databaseId||e.databaseId,t._key.path)}}throw e.Fa("Unsupported field value: "+qs(t))}(t,e)}function bo(t,e){const n={};return M(t)?e.path&&e.path.length>0&&e.fieldMask.push(e.path):j(t,(t,r)=>{const i=_o(r,e.Na(t));null!=i&&(n[t]=i)}),{mapValue:{fields:n}}}function wo(t){return!("object"!=typeof t||null===t||t instanceof Array||t instanceof Date||t instanceof N||t instanceof so||t instanceof ro||t instanceof Gs||t instanceof io)}function Co(t,e,n){if(!wo(n)||!function(t){return"object"==typeof t&&null!==t&&(Object.getPrototypeOf(t)===Object.prototype||null===Object.getPrototypeOf(t))}(n)){const r=qs(n);throw"an object"===r?e.Fa(t+" a custom object"):e.Fa(t+" "+r)}}function To(t,e,n){if((e=Object(o["m"])(e))instanceof no)return e._internalPath;if("string"==typeof e)return So(t,e);throw Io("Field path arguments must be of type string or FieldPath.",t,!1,void 0,n)}const Eo=new RegExp("[~\\*/\\[\\]]");function So(t,e,n){if(e.search(Eo)>=0)throw Io(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,t,!1,void 0,n);try{return new no(...e.split("."))._internalPath}catch(r){throw Io(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,t,!1,void 0,n)}}function Io(t,e,n,r,i){const s=r&&!r.isEmpty(),o=void 0!==i;let a=`Function ${e}() called with invalid data`;n&&(a+=" (via `toFirestore()`)"),a+=". ";let c="";return(s||o)&&(c+=" (found",s&&(c+=" in field "+r),o&&(c+=" in document "+i),c+=")"),new w(b.INVALID_ARGUMENT,a+t+c)}function ko(t,e){return t.some(t=>t.isEqual(e))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xo{constructor(t,e,n,r,i){this._firestore=t,this._userDataWriter=e,this._key=n,this._document=r,this._converter=i}get id(){return this._key.path.lastSegment()}get ref(){return new Gs(this._firestore,this._converter,this._key)}exists(){return null!==this._document}data(){if(this._document){if(this._converter){const t=new Ro(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(t)}return this._userDataWriter.convertValue(this._document.data.value)}}get(t){if(this._document){const e=this._document.data.field(Oo("DocumentSnapshot.get",t));if(null!==e)return this._userDataWriter.convertValue(e)}}}class Ro extends xo{data(){return super.data()}}function Oo(t,e){return"string"==typeof e?So(t,e):e instanceof no?e._internalPath:e._delegate._internalPath}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ao{constructor(t,e){this.hasPendingWrites=t,this.fromCache=e}isEqual(t){return this.hasPendingWrites===t.hasPendingWrites&&this.fromCache===t.fromCache}}class Po extends xo{constructor(t,e,n,r,i,s){super(t,e,n,r,s),this._firestore=t,this._firestoreImpl=t,this.metadata=i}exists(){return super.exists()}data(t={}){if(this._document){if(this._converter){const e=new No(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(e,t)}return this._userDataWriter.convertValue(this._document.data.value,t.serverTimestamps)}}get(t,e={}){if(this._document){const n=this._document.data.field(Oo("DocumentSnapshot.get",t));if(null!==n)return this._userDataWriter.convertValue(n,e.serverTimestamps)}}}class No extends Po{data(t={}){return super.data(t)}}class Do{constructor(t,e,n,r){this._firestore=t,this._userDataWriter=e,this._snapshot=r,this.metadata=new Ao(r.hasPendingWrites,r.fromCache),this.query=n}get docs(){const t=[];return this.forEach(e=>t.push(e)),t}get size(){return this._snapshot.docs.size}get empty(){return 0===this.size}forEach(t,e){this._snapshot.docs.forEach(n=>{t.call(e,new No(this._firestore,this._userDataWriter,n.key,n,new Ao(this._snapshot.mutatedKeys.has(n.key),this._snapshot.fromCache),this.query.converter))})}docChanges(t={}){const e=!!t.includeMetadataChanges;if(e&&this._snapshot.excludesMetadataChanges)throw new w(b.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===e||(this._cachedChanges=function(t,e){if(t._snapshot.oldDocs.isEmpty()){let e=0;return t._snapshot.docChanges.map(n=>({type:"added",doc:new No(t._firestore,t._userDataWriter,n.doc.key,n.doc,new Ao(t._snapshot.mutatedKeys.has(n.doc.key),t._snapshot.fromCache),t.query.converter),oldIndex:-1,newIndex:e++}))}{let n=t._snapshot.oldDocs;return t._snapshot.docChanges.filter(t=>e||3!==t.type).map(e=>{const r=new No(t._firestore,t._userDataWriter,e.doc.key,e.doc,new Ao(t._snapshot.mutatedKeys.has(e.doc.key),t._snapshot.fromCache),t.query.converter);let i=-1,s=-1;return 0!==e.type&&(i=n.indexOf(e.doc.key),n=n.delete(e.doc.key)),1!==e.type&&(n=n.add(e.doc),s=n.indexOf(e.doc.key)),{type:Lo(e.type),doc:r,oldIndex:i,newIndex:s}})}}(this,e),this._cachedChangesIncludeMetadataChanges=e),this._cachedChanges}}function Lo(t){switch(t){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return y()}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function jo(t){if(zt(t)&&0===t.explicitOrderBy.length)throw new w(b.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}class Mo{}function Fo(t,...e){for(const n of e)t=n._apply(t);return t}class Uo extends Mo{constructor(t,e,n){super(),this.Ka=t,this.ja=e,this.Qa=n,this.type="where"}_apply(t){const e=fo(t.firestore),n=function(t,e,n,r,i,s,o){let a;if(i.isKeyField()){if("array-contains"===s||"array-contains-any"===s)throw new w(b.INVALID_ARGUMENT,`Invalid Query. You can't perform '${s}' queries on FieldPath.documentId().`);if("in"===s||"not-in"===s){$o(o,s);const e=[];for(const n of o)e.push(qo(r,t,n));a={arrayValue:{values:e}}}else a=qo(r,t,o)}else"in"!==s&&"not-in"!==s&&"array-contains-any"!==s||$o(o,s),a=vo(n,e,o,"in"===s||"not-in"===s);const c=Et.create(i,s,a);return function(t,e){if(e.v()){const n=Ht(t);if(null!==n&&!n.isEqual(e.field))throw new w(b.INVALID_ARGUMENT,`Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '${n.toString()}' and '${e.field.toString()}'`);const r=Gt(t);null!==r&&Bo(t,e.field,r)}const n=function(t,e){for(const n of t.filters)if(e.indexOf(n.op)>=0)return n.op;return null}(t,function(t){switch(t){case"!=":return["!=","not-in"];case"array-contains":return["array-contains","array-contains-any","not-in"];case"in":return["array-contains-any","in","not-in"];case"array-contains-any":return["array-contains","array-contains-any","in","not-in"];case"not-in":return["array-contains","array-contains-any","in","not-in","!="];default:return[]}}(e.op));if(null!==n)throw n===e.op?new w(b.INVALID_ARGUMENT,`Invalid query. You cannot use more than one '${e.op.toString()}' filter.`):new w(b.INVALID_ARGUMENT,`Invalid query. You cannot use '${e.op.toString()}' filters with '${n.toString()}' filters.`)}(t,c),c}(t._query,"where",e,t.firestore._databaseId,this.Ka,this.ja,this.Qa);return new Hs(t.firestore,t.converter,function(t,e){const n=t.filters.concat([e]);return new Vt(t.path,t.collectionGroup,t.explicitOrderBy.slice(),n,t.limit,t.limitType,t.startAt,t.endAt)}(t._query,n))}}function Vo(t,e,n){const r=e,i=Oo("where",t);return new Uo(i,r,n)}function qo(t,e,n){if("string"==typeof(n=Object(o["m"])(n))){if(""===n)throw new w(b.INVALID_ARGUMENT,"Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");if(!Wt(e)&&-1!==n.indexOf("/"))throw new w(b.INVALID_ARGUMENT,`Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);const r=e.path.child(U.fromString(n));if(!tt.isDocumentKey(r))throw new w(b.INVALID_ARGUMENT,`Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '${r}' is not because it has an odd number of segments (${r.length}).`);return ct(t,new tt(r))}if(n instanceof Gs)return ct(t,n._key);throw new w(b.INVALID_ARGUMENT,`Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: ${qs(n)}.`)}function $o(t,e){if(!Array.isArray(t)||0===t.length)throw new w(b.INVALID_ARGUMENT,`Invalid Query. A non-empty array is required for '${e.toString()}' filters.`);if(t.length>10)throw new w(b.INVALID_ARGUMENT,`Invalid Query. '${e.toString()}' filters support a maximum of 10 elements in the value array.`)}function Bo(t,e,n){if(!n.isEqual(e))throw new w(b.INVALID_ARGUMENT,`Invalid query. You have a where filter with an inequality (<, <=, !=, not-in, >, or >=) on field '${e.toString()}' and so you must also use '${e.toString()}' as your first argument to orderBy(), but your first orderBy() is on field '${n.toString()}' instead.`)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zo{convertValue(t,e="none"){switch(et(t)){case 0:return null;case 1:return t.booleanValue;case 2:return H(t.integerValue||t.doubleValue);case 3:return this.convertTimestamp(t.timestampValue);case 4:return this.convertServerTimestamp(t,e);case 5:return t.stringValue;case 6:return this.convertBytes(W(t.bytesValue));case 7:return this.convertReference(t.referenceValue);case 8:return this.convertGeoPoint(t.geoPointValue);case 9:return this.convertArray(t.arrayValue,e);case 10:return this.convertObject(t.mapValue,e);default:throw y()}}convertObject(t,e){const n={};return j(t.fields,(t,r)=>{n[t]=this.convertValue(r,e)}),n}convertGeoPoint(t){return new so(H(t.latitude),H(t.longitude))}convertArray(t,e){return(t.values||[]).map(t=>this.convertValue(t,e))}convertServerTimestamp(t,e){switch(e){case"previous":const n=Y(t);return null==n?null:this.convertValue(n,e);case"estimate":return this.convertTimestamp(Q(t));default:return null}}convertTimestamp(t){const e=G(t);return new N(e.seconds,e.nanos)}convertDocumentKey(t,e){const n=U.fromString(t);v(zn(n));const r=new Ls(n.get(1),n.get(3)),i=new tt(n.popFirst(5));return r.isEqual(e)||p(`Document ${i} contains a document reference within a different database (${r.projectId}/${r.database}) which is not supported. It will be treated as a reference in the current database (${e.projectId}/${e.database}) instead.`),i}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Ho(t){t=$s(t,Gs);const e=$s(t.firestore,Js);return Ps(to(e),t._key).then(n=>Zo(e,t,n))}class Wo extends zo{constructor(t){super(),this.firestore=t}convertBytes(t){return new ro(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new Gs(this.firestore,null,e)}}function Ko(t){t=$s(t,Hs);const e=$s(t.firestore,Js),n=to(e),r=new Wo(e);return jo(t._query),Ns(n,t._query).then(n=>new Do(e,r,t,n))}function Yo(t,e,n,...r){t=$s(t,Gs);const i=$s(t.firestore,Js),s=fo(i);let a;return a="string"==typeof(e=Object(o["m"])(e))||e instanceof no?yo(s,"updateDoc",t._key,e,n,r):go(s,"updateDoc",t._key,e),Jo(i,[a.toMutation(t._key,be.exists(!0))])}function Qo(t,e){const n=$s(t.firestore,Js),r=Ys(t),i=Go(t.converter,e);return Jo(n,[po(fo(t.firestore),"addDoc",r._key,i,null!==t.converter,{}).toMutation(r._key,be.exists(!1))]).then(()=>r)}function Xo(t,...e){var n,r,i;t=Object(o["m"])(t);let s={includeMetadataChanges:!1},a=0;"object"!=typeof e[a]||Xs(e[a])||(s=e[a],a++);const c={includeMetadataChanges:s.includeMetadataChanges};if(Xs(e[a])){const t=e[a];e[a]=null===(n=t.next)||void 0===n?void 0:n.bind(t),e[a+1]=null===(r=t.error)||void 0===r?void 0:r.bind(t),e[a+2]=null===(i=t.complete)||void 0===i?void 0:i.bind(t)}let u,l,h;if(t instanceof Gs)l=$s(t.firestore,Js),h=$t(t._key.path),u={next:n=>{e[a]&&e[a](Zo(l,t,n))},error:e[a+1],complete:e[a+2]};else{const n=$s(t,Hs);l=$s(n.firestore,Js),h=n._query;const r=new Wo(l);u={next:t=>{e[a]&&e[a](new Do(l,r,n,t))},error:e[a+1],complete:e[a+2]},jo(t._query)}return function(t,e,n,r){const i=new Es(r),s=new Ki(e,i,n);return t.asyncQueue.enqueueAndForget(async()=>Bi(await As(t),s)),()=>{i.Xo(),t.asyncQueue.enqueueAndForget(async()=>zi(await As(t),s))}}(to(l),h,c,u)}function Jo(t,e){return function(t,e){const n=new C;return t.asyncQueue.enqueueAndForget(async()=>is(await Os(t),e,n)),n.promise}(to(t),e)}function Zo(t,e,n){const r=n.docs.get(e._key),i=new Wo(t);return new Po(t,i,e._key,r,new Ao(n.hasPendingWrites,n.fromCache),e.converter)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const x="FirebaseError";class R extends Error{constructor(t,e,n){super(e),this.code=t,this.customData=n,this.name=x,Object.setPrototypeOf(this,R.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,O.prototype.create)}}class O{constructor(t,e,n){this.service=t,this.serviceName=e,this.errors=n}create(t,...e){const n=e[0]||{},r=`${this.service}/${t}`,i=this.errors[t],s=i?A(i,n):"Error",o=`${this.serviceName}: ${s} (${r}).`,a=new R(r,o,n);return a}}function A(t,e){return t.replace(P,(t,n)=>{const r=e[n];return null!=r?String(r):`<${n}?>`})}const P=/\{\$([^}]+)}/g;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const L=function(t){let e={},n={},r={},i="";try{const s=t.split(".");e=N(h(s[0])||""),n=N(h(s[1])||""),i=s[2],r=n["d"]||{},delete n["d"]}catch(s){}return{header:e,claims:n,data:r,signature:i}},j=function(t){const e=L(t),n=e.claims;return!!n&&"object"===typeof n&&n.hasOwnProperty("iat")},M=function(t){const e=L(t).claims;return"object"===typeof e&&!0===e["admin"]};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function z(t){const e=[];for(const[n,r]of Object.entries(t))Array.isArray(r)?r.forEach(t=>{e.push(encodeURIComponent(n)+"="+encodeURIComponent(t))}):e.push(encodeURIComponent(n)+"="+encodeURIComponent(r));return e.length?"&"+e.join("&"):""}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const f=function(t){try{if("undefined"!==typeof window&&"undefined"!==typeof window[t]){const e=window[t];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new h(e)}}catch(e){}return new d},p=f("localStorage"),m=f("sessionStorage"),g=new o["b"]("@firebase/database"),y=function(){let t=1;return function(){return t++}}(),v=function(t){const e=Object(s["F"])(t),n=new s["c"];n.update(e);const r=n.digest();return s["f"].encodeByteArray(r)},_=function(...t){let e="";for(let n=0;n<t.length;n++){const r=t[n];Array.isArray(r)||r&&"object"===typeof r&&"number"===typeof r.length?e+=_.apply(null,r):e+="object"===typeof r?Object(s["G"])(r):r,e+=" "}return e};let b=null,w=!0;const C=function(t,e){Object(s["d"])(!e||!0===t||!1===t,"Can't turn on custom loggers persistently."),!0===t?(g.logLevel=o["a"].VERBOSE,b=g.log.bind(g),e&&m.set("logging_enabled",!0)):"function"===typeof t?b=t:(b=null,m.remove("logging_enabled"))},T=function(...t){if(!0===w&&(w=!1,null===b&&!0===m.get("logging_enabled")&&C(!0)),b){const e=_.apply(null,t);b(e)}},E=function(t){return function(...e){T(t,...e)}},S=function(...t){const e="FIREBASE INTERNAL ERROR: "+_(...t);g.error(e)},I=function(...t){const e="FIREBASE FATAL ERROR: "+_(...t);throw g.error(e),new Error(e)},k=function(...t){const e="FIREBASE WARNING: "+_(...t);g.warn(e)},x=function(){"undefined"!==typeof window&&window.location&&window.location.protocol&&-1!==window.location.protocol.indexOf("https:")&&k("Insecure Firebase access from a secure page. Please use https in calls to new Firebase().")},R=function(t){return"number"===typeof t&&(t!==t||t===Number.POSITIVE_INFINITY||t===Number.NEGATIVE_INFINITY)},O=function(t){if(Object(s["v"])()||"complete"===document.readyState)t();else{let e=!1;const n=function(){document.body?e||(e=!0,t()):setTimeout(n,Math.floor(10))};document.addEventListener?(document.addEventListener("DOMContentLoaded",n,!1),window.addEventListener("load",n,!1)):document.attachEvent&&(document.attachEvent("onreadystatechange",()=>{"complete"===document.readyState&&n()}),window.attachEvent("onload",n))}},A="[MIN_NAME]",P="[MAX_NAME]",N=function(t,e){if(t===e)return 0;if(t===A||e===P)return-1;if(e===A||t===P)return 1;{const n=H(t),r=H(e);return null!==n?null!==r?n-r===0?t.length-e.length:n-r:-1:null!==r?1:t<e?-1:1}},D=function(t,e){return t===e?0:t<e?-1:1},L=function(t,e){if(e&&t in e)return e[t];throw new Error("Missing required key ("+t+") in object: "+Object(s["G"])(e))},j=function(t){if("object"!==typeof t||null===t)return Object(s["G"])(t);const e=[];for(const r in t)e.push(r);e.sort();let n="{";for(let r=0;r<e.length;r++)0!==r&&(n+=","),n+=Object(s["G"])(e[r]),n+=":",n+=j(t[e[r]]);return n+="}",n},M=function(t,e){const n=t.length;if(n<=e)return[t];const r=[];for(let i=0;i<n;i+=e)i+e>n?r.push(t.substring(i,n)):r.push(t.substring(i,i+e));return r};function F(t,e){for(const n in t)t.hasOwnProperty(n)&&e(n,t[n])}const U=function(t){Object(s["d"])(!R(t),"Invalid JSON number");const e=11,n=52,r=(1<<e-1)-1;let i,o,a,c,u;0===t?(o=0,a=0,i=1/t===-1/0?1:0):(i=t<0,t=Math.abs(t),t>=Math.pow(2,1-r)?(c=Math.min(Math.floor(Math.log(t)/Math.LN2),r),o=c+r,a=Math.round(t*Math.pow(2,n-c)-Math.pow(2,n))):(o=0,a=Math.round(t/Math.pow(2,1-r-n))));const l=[];for(u=n;u;u-=1)l.push(a%2?1:0),a=Math.floor(a/2);for(u=e;u;u-=1)l.push(o%2?1:0),o=Math.floor(o/2);l.push(i?1:0),l.reverse();const h=l.join("");let d="";for(u=0;u<64;u+=8){let t=parseInt(h.substr(u,8),2).toString(16);1===t.length&&(t="0"+t),d+=t}return d.toLowerCase()},V=function(){return!("object"!==typeof window||!window["chrome"]||!window["chrome"]["extension"]||/^chrome/.test(window.location.href))},q=function(){return"object"===typeof Windows&&"object"===typeof Windows.UI};function $(t,e){let n="Unknown Error";"too_big"===t?n="The data requested exceeds the maximum size that can be accessed with a single request.":"permission_denied"===t?n="Client doesn't have permission to access the desired data.":"unavailable"===t&&(n="The service is unavailable");const r=new Error(t+" at "+e._path.toString()+": "+n);return r.code=t.toUpperCase(),r}const B=new RegExp("^-?(0*)\\d{1,10}$"),z=-2147483648,G=2147483647,H=function(t){if(B.test(t)){const e=Number(t);if(e>=z&&e<=G)return e}return null},W=function(t){try{t()}catch(e){setTimeout(()=>{const t=e.stack||"";throw k("Exception was thrown by user callback.",t),e},Math.floor(0))}},K=function(){const t="object"===typeof window&&window["navigator"]&&window["navigator"]["userAgent"]||"";return t.search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0},Y=function(t,e){const n=setTimeout(t,e);return"object"===typeof n&&n["unref"]&&n["unref"](),n};
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class X{constructor(t,e,n){this.appName_=t,this.firebaseOptions_=e,this.authProvider_=n,this.auth_=null,this.auth_=n.getImmediate({optional:!0}),this.auth_||n.onInit(t=>this.auth_=t)}getToken(t){return this.auth_?this.auth_.getToken(t).catch(t=>t&&"auth/token-not-initialized"===t.code?(T("Got auth/token-not-initialized error.  Treating as null token."),null):Promise.reject(t)):new Promise((e,n)=>{setTimeout(()=>{this.auth_?this.getToken(t).then(e,n):e(null)},0)})}addTokenChangeListener(t){this.auth_?this.auth_.addAuthTokenListener(t):this.authProvider_.get().then(e=>e.addAuthTokenListener(t))}removeTokenChangeListener(t){this.authProvider_.get().then(e=>e.removeAuthTokenListener(t))}notifyForInvalidToken(){let t='Provided authentication credentials for the app named "'+this.appName_+'" are invalid. This usually indicates your app was not initialized correctly. ';"credential"in this.firebaseOptions_?t+='Make sure the "credential" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':"serviceAccount"in this.firebaseOptions_?t+='Make sure the "serviceAccount" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':t+='Make sure the "apiKey" and "databaseURL" properties provided to initializeApp() match the values provided for your app at https://console.firebase.google.com/.',k(t)}}class J{constructor(t){this.accessToken=t}getToken(t){return Promise.resolve({accessToken:this.accessToken})}addTokenChangeListener(t){t(this.accessToken)}removeTokenChangeListener(t){}notifyForInvalidToken(){}}J.OWNER="owner";
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pt={},mt={};function gt(t){const e=t.toString();return pt[e]||(pt[e]=new ft),pt[e]}function yt(t,e){const n=t.toString();return mt[n]||(mt[n]=e()),mt[n]}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _t="start",bt="close",wt="pLPCommand",Ct="pRTLPCB",Tt="id",Et="pw",St="ser",It="cb",kt="seg",xt="ts",Rt="d",Ot="dframe",At=1870,Pt=30,Nt=At-Pt,Dt=25e3,Lt=3e4;class jt{constructor(t,e,n,r,i,s,o){this.connId=t,this.repoInfo=e,this.applicationId=n,this.appCheckToken=r,this.authToken=i,this.transportSessionId=s,this.lastSessionId=o,this.bytesSent=0,this.bytesReceived=0,this.everConnected_=!1,this.log_=E(t),this.stats_=gt(e),this.urlFn=t=>(this.appCheckToken&&(t[at]=this.appCheckToken),dt(e,ut,t))}open(t,e){this.curSegmentNum=0,this.onDisconnect_=e,this.myPacketOrderer=new vt(t),this.isClosed_=!1,this.connectTimeoutTimer_=setTimeout(()=>{this.log_("Timed out trying to connect."),this.onClosed_(),this.connectTimeoutTimer_=null},Math.floor(Lt)),O(()=>{if(this.isClosed_)return;this.scriptTagHolder=new Mt((...t)=>{const[e,n,r,i,s]=t;if(this.incrementIncomingBytes_(t),this.scriptTagHolder)if(this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null),this.everConnected_=!0,e===_t)this.id=n,this.password=r;else{if(e!==bt)throw new Error("Unrecognized command received: "+e);n?(this.scriptTagHolder.sendNewPolls=!1,this.myPacketOrderer.closeAfter(n,()=>{this.onClosed_()})):this.onClosed_()}},(...t)=>{const[e,n]=t;this.incrementIncomingBytes_(t),this.myPacketOrderer.handleResponse(e,n)},()=>{this.onClosed_()},this.urlFn);const t={};t[_t]="t",t[St]=Math.floor(1e8*Math.random()),this.scriptTagHolder.uniqueCallbackIdentifier&&(t[It]=this.scriptTagHolder.uniqueCallbackIdentifier),t[tt]=Z,this.transportSessionId&&(t[et]=this.transportSessionId),this.lastSessionId&&(t[st]=this.lastSessionId),this.applicationId&&(t[ot]=this.applicationId),this.appCheckToken&&(t[at]=this.appCheckToken),"undefined"!==typeof location&&location.hostname&&it.test(location.hostname)&&(t[nt]=rt);const e=this.urlFn(t);this.log_("Connecting via long-poll to "+e),this.scriptTagHolder.addTag(e,()=>{})})}start(){this.scriptTagHolder.startLongPoll(this.id,this.password),this.addDisconnectPingFrame(this.id,this.password)}static forceAllow(){jt.forceAllow_=!0}static forceDisallow(){jt.forceDisallow_=!0}static isAvailable(){return!Object(s["v"])()&&(!!jt.forceAllow_||!jt.forceDisallow_&&"undefined"!==typeof document&&null!=document.createElement&&!V()&&!q())}markConnectionHealthy(){}shutdown_(){this.isClosed_=!0,this.scriptTagHolder&&(this.scriptTagHolder.close(),this.scriptTagHolder=null),this.myDisconnFrame&&(document.body.removeChild(this.myDisconnFrame),this.myDisconnFrame=null),this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null)}onClosed_(){this.isClosed_||(this.log_("Longpoll is closing itself"),this.shutdown_(),this.onDisconnect_&&(this.onDisconnect_(this.everConnected_),this.onDisconnect_=null))}close(){this.isClosed_||(this.log_("Longpoll is being closed."),this.shutdown_())}send(t){const e=Object(s["G"])(t);this.bytesSent+=e.length,this.stats_.incrementCounter("bytes_sent",e.length);const n=Object(s["g"])(e),r=M(n,Nt);for(let i=0;i<r.length;i++)this.scriptTagHolder.enqueueSegment(this.curSegmentNum,r.length,r[i]),this.curSegmentNum++}addDisconnectPingFrame(t,e){if(Object(s["v"])())return;this.myDisconnFrame=document.createElement("iframe");const n={};n[Ot]="t",n[Tt]=t,n[Et]=e,this.myDisconnFrame.src=this.urlFn(n),this.myDisconnFrame.style.display="none",document.body.appendChild(this.myDisconnFrame)}incrementIncomingBytes_(t){const e=Object(s["G"])(t).length;this.bytesReceived+=e,this.stats_.incrementCounter("bytes_received",e)}}class Mt{constructor(t,e,n,r){if(this.onDisconnect=n,this.urlFn=r,this.outstandingRequests=new Set,this.pendingSegs=[],this.currentSerial=Math.floor(1e8*Math.random()),this.sendNewPolls=!0,Object(s["v"])())this.commandCB=t,this.onMessageCB=e;else{this.uniqueCallbackIdentifier=y(),window[wt+this.uniqueCallbackIdentifier]=t,window[Ct+this.uniqueCallbackIdentifier]=e,this.myIFrame=Mt.createIFrame_();let n="";if(this.myIFrame.src&&"javascript:"===this.myIFrame.src.substr(0,"javascript:".length)){const t=document.domain;n='<script>document.domain="'+t+'";<\/script>'}const r="<html><body>"+n+"</body></html>";try{this.myIFrame.doc.open(),this.myIFrame.doc.write(r),this.myIFrame.doc.close()}catch(i){T("frame writing exception"),i.stack&&T(i.stack),T(i)}}}static createIFrame_(){const t=document.createElement("iframe");if(t.style.display="none",!document.body)throw"Document body has not initialized. Wait to initialize Firebase until after the document is ready.";document.body.appendChild(t);try{const e=t.contentWindow.document;e||T("No IE domain setting required")}catch(e){const n=document.domain;t.src="javascript:void((function(){document.open();document.domain='"+n+"';document.close();})())"}return t.contentDocument?t.doc=t.contentDocument:t.contentWindow?t.doc=t.contentWindow.document:t.document&&(t.doc=t.document),t}close(){this.alive=!1,this.myIFrame&&(this.myIFrame.doc.body.innerHTML="",setTimeout(()=>{null!==this.myIFrame&&(document.body.removeChild(this.myIFrame),this.myIFrame=null)},Math.floor(0)));const t=this.onDisconnect;t&&(this.onDisconnect=null,t())}startLongPoll(t,e){this.myID=t,this.myPW=e,this.alive=!0;while(this.newRequest_());}newRequest_(){if(this.alive&&this.sendNewPolls&&this.outstandingRequests.size<(this.pendingSegs.length>0?2:1)){this.currentSerial++;const t={};t[Tt]=this.myID,t[Et]=this.myPW,t[St]=this.currentSerial;let e=this.urlFn(t),n="",r=0;while(this.pendingSegs.length>0){const t=this.pendingSegs[0];if(!(t.d.length+Pt+n.length<=At))break;{const t=this.pendingSegs.shift();n=n+"&"+kt+r+"="+t.seg+"&"+xt+r+"="+t.ts+"&"+Rt+r+"="+t.d,r++}}return e+=n,this.addLongPollTag_(e,this.currentSerial),!0}return!1}enqueueSegment(t,e,n){this.pendingSegs.push({seg:t,ts:e,d:n}),this.alive&&this.newRequest_()}addLongPollTag_(t,e){this.outstandingRequests.add(e);const n=()=>{this.outstandingRequests.delete(e),this.newRequest_()},r=setTimeout(n,Math.floor(Dt)),i=()=>{clearTimeout(r),n()};this.addTag(t,i)}addTag(t,e){Object(s["v"])()?this.doNodeLongPoll(t,e):setTimeout(()=>{try{if(!this.sendNewPolls)return;const n=this.myIFrame.doc.createElement("script");n.type="text/javascript",n.async=!0,n.src=t,n.onload=n.onreadystatechange=function(){const t=n.readyState;t&&"loaded"!==t&&"complete"!==t||(n.onload=n.onreadystatechange=null,n.parentNode&&n.parentNode.removeChild(n),e())},n.onerror=()=>{T("Long-poll script failed to load: "+t),this.sendNewPolls=!1,this.close()},this.myIFrame.doc.body.appendChild(n)}catch(n){}},Math.floor(1))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ue{getCompare(){return this.compare.bind(this)}indexedValueChanged(t,e){const n=new Fe(A,t),r=new Fe(A,e);return 0!==this.compare(n,r)}minPost(){return Fe.MIN}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ve;class qe extends Ue{static get __EMPTY_NODE(){return Ve}static set __EMPTY_NODE(t){Ve=t}compare(t,e){return N(t.name,e.name)}isDefinedOn(t){throw Object(s["e"])("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(t,e){return!1}minPost(){return Fe.MIN}maxPost(){return new Fe(P,Ve)}makePost(t,e){return Object(s["d"])("string"===typeof t,"KeyIndex indexValue must always be a string."),new Fe(t,Ve)}toString(){return".key"}}const $e=new qe;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function We(t,e){return N(t.name,e.name)}function Ke(t,e){return N(t,e)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class un{constructor(t){const e=t=>parseInt(Math.log(t)/cn,10),n=t=>parseInt(Array(t+1).join("1"),2);this.count=e(t+1),this.current_=this.count-1;const r=n(this.count);this.bits_=t+1&r}nextBitIsOne(){const t=!(this.bits_&1<<this.current_);return this.current_--,t}}const ln=function(t,e,n,r){t.sort(e);const i=function(e,r){const s=r-e;let o,a;if(0===s)return null;if(1===s)return o=t[e],a=n?n(o):o,new ze(a,o.node,ze.BLACK,null,null);{const c=parseInt(s/2,10)+e,u=i(e,c),l=i(c+1,r);return o=t[c],a=n?n(o):o,new ze(a,o.node,ze.BLACK,u,l)}},s=function(e){let r=null,s=null,o=t.length;const a=function(e,r){const s=o-e,a=o;o-=e;const u=i(s+1,a),l=t[s],h=n?n(l):l;c(new ze(h,l.node,r,null,u))},c=function(t){r?(r.left=t,r=t):(s=t,r=t)};for(let t=0;t<e.count;++t){const n=e.nextBitIsOne(),r=Math.pow(2,e.count-(t+1));n?a(r,ze.BLACK):(a(r,ze.BLACK),a(r,ze.RED))}return s},o=new un(t.length),a=s(o);return new He(r||e,a)};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
const vn=!0;function _n(t,e=null){if(null===t)return mn.EMPTY_NODE;if("object"===typeof t&&".priority"in t&&(e=t[".priority"]),Object(s["d"])(null===e||"string"===typeof e||"number"===typeof e||"object"===typeof e&&".sv"in e,"Invalid priority type found: "+typeof e),"object"===typeof t&&".value"in t&&null!==t[".value"]&&(t=t[".value"]),"object"!==typeof t||".sv"in t){const n=t;return new nn(n,_n(e))}if(t instanceof Array||!vn){let n=mn.EMPTY_NODE;return F(t,(e,r)=>{if(Object(s["h"])(t,e)&&"."!==e.substring(0,1)){const t=_n(r);!t.isLeafNode()&&t.isEmpty()||(n=n.updateImmediateChild(e,t))}}),n.updatePriority(_n(e))}{const n=[];let r=!1;const i=t;if(F(i,(t,e)=>{if("."!==t.substring(0,1)){const i=_n(e);i.isEmpty()||(r=r||!i.getPriority().isEmpty(),n.push(new Fe(t,i)))}}),0===n.length)return mn.EMPTY_NODE;const s=ln(n,We,t=>t.name,Ke);if(r){const t=ln(n,an.getCompare());return new mn(s,_n(e),new fn({".priority":t},{".priority":an}))}return new mn(s,_n(e),fn.Default)}}rn(_n);
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wn extends Ue{compare(t,e){const n=t.node.compareTo(e.node);return 0===n?N(t.name,e.name):n}isDefinedOn(t){return!0}indexedValueChanged(t,e){return!t.equals(e)}minPost(){return Fe.MIN}maxPost(){return Fe.MAX}makePost(t,e){const n=_n(t);return new Fe(e,n)}toString(){return".value"}}const Cn=new wn,Tn="-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz",En=function(){let t=0;const e=[];return function(n){const r=n===t;let i;t=n;const o=new Array(8);for(i=7;i>=0;i--)o[i]=Tn.charAt(n%64),n=Math.floor(n/64);Object(s["d"])(0===n,"Cannot push at time == 0");let a=o.join("");if(r){for(i=11;i>=0&&63===e[i];i--)e[i]=0;e[i]++}else for(i=0;i<12;i++)e[i]=Math.floor(64*Math.random());for(i=0;i<12;i++)a+=Tn.charAt(e[i]);return Object(s["d"])(20===a.length,"nextPushId: Length should be 20."),a}}();
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function Sn(t){return{type:"value",snapshotNode:t}}function In(t,e){return{type:"child_added",snapshotNode:e,childName:t}}function kn(t,e){return{type:"child_removed",snapshotNode:e,childName:t}}function xn(t,e,n){return{type:"child_changed",snapshotNode:e,childName:t,oldSnap:n}}function Rn(t,e){return{type:"child_moved",snapshotNode:e,childName:t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class On{constructor(t){this.index_=t}updateChild(t,e,n,r,i,o){Object(s["d"])(t.isIndexed(this.index_),"A node must be indexed if only a child is updated");const a=t.getImmediateChild(e);return a.getChild(r).equals(n.getChild(r))&&a.isEmpty()===n.isEmpty()?t:(null!=o&&(n.isEmpty()?t.hasChild(e)?o.trackChildChange(kn(e,a)):Object(s["d"])(t.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):a.isEmpty()?o.trackChildChange(In(e,n)):o.trackChildChange(xn(e,n,a))),t.isLeafNode()&&n.isEmpty()?t:t.updateImmediateChild(e,n).withIndex(this.index_))}updateFullNode(t,e,n){return null!=n&&(t.isLeafNode()||t.forEachChild(an,(t,r)=>{e.hasChild(t)||n.trackChildChange(kn(t,r))}),e.isLeafNode()||e.forEachChild(an,(e,r)=>{if(t.hasChild(e)){const i=t.getImmediateChild(e);i.equals(r)||n.trackChildChange(xn(e,r,i))}else n.trackChildChange(In(e,r))})),e.withIndex(this.index_)}updatePriority(t,e){return t.isEmpty()?mn.EMPTY_NODE:t.updatePriority(e)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pn{constructor(t){this.rangedFilter_=new An(t),this.index_=t.getIndex(),this.limit_=t.getLimit(),this.reverse_=!t.isViewFromLeft()}updateChild(t,e,n,r,i,s){return this.rangedFilter_.matches(new Fe(e,n))||(n=mn.EMPTY_NODE),t.getImmediateChild(e).equals(n)?t:t.numChildren()<this.limit_?this.rangedFilter_.getIndexedFilter().updateChild(t,e,n,r,i,s):this.fullLimitUpdateChild_(t,e,n,i,s)}updateFullNode(t,e,n){let r;if(e.isLeafNode()||e.isEmpty())r=mn.EMPTY_NODE.withIndex(this.index_);else if(2*this.limit_<e.numChildren()&&e.isIndexed(this.index_)){let t;r=mn.EMPTY_NODE.withIndex(this.index_),t=this.reverse_?e.getReverseIteratorFrom(this.rangedFilter_.getEndPost(),this.index_):e.getIteratorFrom(this.rangedFilter_.getStartPost(),this.index_);let n=0;while(t.hasNext()&&n<this.limit_){const e=t.getNext();let i;if(i=this.reverse_?this.index_.compare(this.rangedFilter_.getStartPost(),e)<=0:this.index_.compare(e,this.rangedFilter_.getEndPost())<=0,!i)break;r=r.updateImmediateChild(e.name,e.node),n++}}else{let t,n,i,s;if(r=e.withIndex(this.index_),r=r.updatePriority(mn.EMPTY_NODE),this.reverse_){s=r.getReverseIterator(this.index_),t=this.rangedFilter_.getEndPost(),n=this.rangedFilter_.getStartPost();const e=this.index_.getCompare();i=(t,n)=>e(n,t)}else s=r.getIterator(this.index_),t=this.rangedFilter_.getStartPost(),n=this.rangedFilter_.getEndPost(),i=this.index_.getCompare();let o=0,a=!1;while(s.hasNext()){const e=s.getNext();!a&&i(t,e)<=0&&(a=!0);const c=a&&o<this.limit_&&i(e,n)<=0;c?o++:r=r.updateImmediateChild(e.name,mn.EMPTY_NODE)}}return this.rangedFilter_.getIndexedFilter().updateFullNode(t,r,n)}updatePriority(t,e){return t}filtersNodes(){return!0}getIndexedFilter(){return this.rangedFilter_.getIndexedFilter()}getIndex(){return this.index_}fullLimitUpdateChild_(t,e,n,r,i){let o;if(this.reverse_){const t=this.index_.getCompare();o=(e,n)=>t(n,e)}else o=this.index_.getCompare();const a=t;Object(s["d"])(a.numChildren()===this.limit_,"");const c=new Fe(e,n),u=this.reverse_?a.getFirstChild(this.index_):a.getLastChild(this.index_),l=this.rangedFilter_.matches(c);if(a.hasChild(e)){const t=a.getImmediateChild(e);let s=r.getChildAfterChild(this.index_,u,this.reverse_);while(null!=s&&(s.name===e||a.hasChild(s.name)))s=r.getChildAfterChild(this.index_,s,this.reverse_);const h=null==s?1:o(s,c),d=l&&!n.isEmpty()&&h>=0;if(d)return null!=i&&i.trackChildChange(xn(e,n,t)),a.updateImmediateChild(e,n);{null!=i&&i.trackChildChange(kn(e,t));const n=a.updateImmediateChild(e,mn.EMPTY_NODE),r=null!=s&&this.rangedFilter_.matches(s);return r?(null!=i&&i.trackChildChange(In(s.name,s.node)),n.updateImmediateChild(s.name,s.node)):n}}return n.isEmpty()?t:l&&o(u,c)>=0?(null!=i&&(i.trackChildChange(kn(u.name,u.node)),i.trackChildChange(In(e,n))),a.updateImmediateChild(e,n).updateImmediateChild(u.name,mn.EMPTY_NODE)):t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nn{constructor(){this.limitSet_=!1,this.startSet_=!1,this.startNameSet_=!1,this.startAfterSet_=!1,this.endSet_=!1,this.endNameSet_=!1,this.endBeforeSet_=!1,this.limit_=0,this.viewFrom_="",this.indexStartValue_=null,this.indexStartName_="",this.indexEndValue_=null,this.indexEndName_="",this.index_=an}hasStart(){return this.startSet_}hasStartAfter(){return this.startAfterSet_}hasEndBefore(){return this.endBeforeSet_}isViewFromLeft(){return""===this.viewFrom_?this.startSet_:"l"===this.viewFrom_}getIndexStartValue(){return Object(s["d"])(this.startSet_,"Only valid if start has been set"),this.indexStartValue_}getIndexStartName(){return Object(s["d"])(this.startSet_,"Only valid if start has been set"),this.startNameSet_?this.indexStartName_:A}hasEnd(){return this.endSet_}getIndexEndValue(){return Object(s["d"])(this.endSet_,"Only valid if end has been set"),this.indexEndValue_}getIndexEndName(){return Object(s["d"])(this.endSet_,"Only valid if end has been set"),this.endNameSet_?this.indexEndName_:P}hasLimit(){return this.limitSet_}hasAnchoredLimit(){return this.limitSet_&&""!==this.viewFrom_}getLimit(){return Object(s["d"])(this.limitSet_,"Only valid if limit has been set"),this.limit_}getIndex(){return this.index_}loadsAllData(){return!(this.startSet_||this.endSet_||this.limitSet_)}isDefault(){return this.loadsAllData()&&this.index_===an}copy(){const t=new Nn;return t.limitSet_=this.limitSet_,t.limit_=this.limit_,t.startSet_=this.startSet_,t.indexStartValue_=this.indexStartValue_,t.startNameSet_=this.startNameSet_,t.indexStartName_=this.indexStartName_,t.endSet_=this.endSet_,t.indexEndValue_=this.indexEndValue_,t.endNameSet_=this.endNameSet_,t.indexEndName_=this.indexEndName_,t.index_=this.index_,t.viewFrom_=this.viewFrom_,t}}function Dn(t){return t.loadsAllData()?new On(t.getIndex()):t.hasLimit()?new Pn(t):new An(t)}function Ln(t){const e={};if(t.isDefault())return e;let n;return t.index_===an?n="$priority":t.index_===Cn?n="$value":t.index_===$e?n="$key":(Object(s["d"])(t.index_ instanceof bn,"Unrecognized index type!"),n=t.index_.toString()),e["orderBy"]=Object(s["G"])(n),t.startSet_&&(e["startAt"]=Object(s["G"])(t.indexStartValue_),t.startNameSet_&&(e["startAt"]+=","+Object(s["G"])(t.indexStartName_))),t.endSet_&&(e["endAt"]=Object(s["G"])(t.indexEndValue_),t.endNameSet_&&(e["endAt"]+=","+Object(s["G"])(t.indexEndName_))),t.limitSet_&&(t.isViewFromLeft()?e["limitToFirst"]=t.limit_:e["limitToLast"]=t.limit_),e}function jn(t){const e={};if(t.startSet_&&(e["sp"]=t.indexStartValue_,t.startNameSet_&&(e["sn"]=t.indexStartName_)),t.endSet_&&(e["ep"]=t.indexEndValue_,t.endNameSet_&&(e["en"]=t.indexEndName_)),t.limitSet_){e["l"]=t.limit_;let n=t.viewFrom_;""===n&&(n=t.isViewFromLeft()?"l":"r"),e["vf"]=n}return t.index_!==an&&(e["i"]=t.index_.toString()),e}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fn{constructor(){this.rootNode_=mn.EMPTY_NODE}getNode(t){return this.rootNode_.getChild(t)}updateSnapshot(t,e){this.rootNode_=this.rootNode_.updateChild(t,e)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zn=1e4,Gn=3e4,Hn=3e5;class Wn{constructor(t,e){this.server_=e,this.statsToReport_={},this.statsListener_=new Bn(t);const n=zn+(Gn-zn)*Math.random();Y(this.reportStats_.bind(this),Math.floor(n))}reportStats_(){const t=this.statsListener_.get(),e={};let n=!1;F(t,(t,r)=>{r>0&&Object(s["h"])(this.statsToReport_,t)&&(e[t]=r,n=!0)}),n&&this.server_.reportStats(e),Y(this.reportStats_.bind(this),Math.floor(2*Math.random()*Hn))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rr{constructor(t){this.query_=t,this.index_=this.query_._queryParams.getIndex()}}function ir(t,e,n,r){const i=[],s=[];return e.forEach(e=>{"child_changed"===e.type&&t.index_.indexedValueChanged(e.oldSnap,e.snapshotNode)&&s.push(Rn(e.childName,e.snapshotNode))}),sr(t,i,"child_removed",e,r,n),sr(t,i,"child_added",e,r,n),sr(t,i,"child_moved",s,r,n),sr(t,i,"child_changed",e,r,n),sr(t,i,"value",e,r,n),i}function sr(t,e,n,r,i,s){const o=r.filter(t=>t.type===n);o.sort((e,n)=>ar(t,e,n)),o.forEach(n=>{const r=or(t,n,s);i.forEach(i=>{i.respondsTo(n.type)&&e.push(i.createEvent(r,t.query_))})})}function or(t,e,n){return"value"===e.type||"child_removed"===e.type||(e.prevName=n.getPredecessorChildName(e.childName,e.snapshotNode,t.index_)),e}function ar(t,e,n){if(null==e.childName||null==n.childName)throw Object(s["e"])("Should only compare child_ events.");const r=new Fe(e.childName,e.snapshotNode),i=new Fe(n.childName,n.snapshotNode);return t.index_.compare(r,i)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gr{constructor(t){this.writeTree_=t}static empty(){return new gr(new mr(null))}}function yr(t,e,n){if(_e(e))return new gr(new mr(n));{const r=t.writeTree_.findRootMostValueAndPath(e);if(null!=r){const i=r.path;let s=r.value;const o=be(i,e);return s=s.updateChild(o,n),new gr(t.writeTree_.set(i,s))}{const r=new mr(n),i=t.writeTree_.setTree(e,r);return new gr(i)}}}function vr(t,e,n){let r=t;return F(n,(t,n)=>{r=yr(r,ve(e,t),n)}),r}function _r(t,e){if(_e(e))return gr.empty();{const n=t.writeTree_.setTree(e,new mr(null));return new gr(n)}}function br(t,e){return null!=wr(t,e)}function wr(t,e){const n=t.writeTree_.findRootMostValueAndPath(e);return null!=n?t.writeTree_.get(n.path).getChild(be(n.path,e)):null}function Cr(t){const e=[],n=t.writeTree_.value;return null!=n?n.isLeafNode()||n.forEachChild(an,(t,n)=>{e.push(new Fe(t,n))}):t.writeTree_.children.inorderTraversal((t,n)=>{null!=n.value&&e.push(new Fe(t,n.value))}),e}function Tr(t,e){if(_e(e))return t;{const n=wr(t,e);return new gr(null!=n?new mr(n):t.writeTree_.subtree(e))}}function Er(t){return t.writeTree_.isEmpty()}function Sr(t,e){return Ir(le(),t.writeTree_,e)}function Ir(t,e,n){if(null!=e.value)return n.updateChild(t,e.value);{let r=null;return e.children.inorderTraversal((e,i)=>{".priority"===e?(Object(s["d"])(null!==i.value,"Priority writes must always be leaf nodes"),r=i.value):n=Ir(ve(t,e),i,n)}),n.getChild(t).isEmpty()||null===r||(n=n.updateChild(ve(t,".priority"),r)),n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kr(t,e){return Yr(e,t)}function xr(t,e,n,r,i){Object(s["d"])(r>t.lastWriteId,"Stacking an older write on top of newer ones"),void 0===i&&(i=!0),t.allWrites.push({path:e,snap:n,writeId:r,visible:i}),i&&(t.visibleWrites=yr(t.visibleWrites,e,n)),t.lastWriteId=r}function Rr(t,e){for(let n=0;n<t.allWrites.length;n++){const r=t.allWrites[n];if(r.writeId===e)return r}return null}function Or(t,e){const n=t.allWrites.findIndex(t=>t.writeId===e);Object(s["d"])(n>=0,"removeWrite called with nonexistent writeId.");const r=t.allWrites[n];t.allWrites.splice(n,1);let i=r.visible,o=!1,a=t.allWrites.length-1;while(i&&a>=0){const e=t.allWrites[a];e.visible&&(a>=n&&Ar(e,r.path)?i=!1:Ce(r.path,e.path)&&(o=!0)),a--}if(i){if(o)return Pr(t),!0;if(r.snap)t.visibleWrites=_r(t.visibleWrites,r.path);else{const e=r.children;F(e,e=>{t.visibleWrites=_r(t.visibleWrites,ve(r.path,e))})}return!0}return!1}function Ar(t,e){if(t.snap)return Ce(t.path,e);for(const n in t.children)if(t.children.hasOwnProperty(n)&&Ce(ve(t.path,n),e))return!0;return!1}function Pr(t){t.visibleWrites=Dr(t.allWrites,Nr,le()),t.allWrites.length>0?t.lastWriteId=t.allWrites[t.allWrites.length-1].writeId:t.lastWriteId=-1}function Nr(t){return t.visible}function Dr(t,e,n){let r=gr.empty();for(let i=0;i<t.length;++i){const o=t[i];if(e(o)){const t=o.path;let e;if(o.snap)Ce(n,t)?(e=be(n,t),r=yr(r,e,o.snap)):Ce(t,n)&&(e=be(t,n),r=yr(r,le(),o.snap.getChild(e)));else{if(!o.children)throw Object(s["e"])("WriteRecord should have .snap or .children");if(Ce(n,t))e=be(n,t),r=vr(r,e,o.children);else if(Ce(t,n))if(e=be(t,n),_e(e))r=vr(r,le(),o.children);else{const t=Object(s["D"])(o.children,he(e));if(t){const n=t.getChild(fe(e));r=yr(r,le(),n)}}}}}return r}function Lr(t,e,n,r,i){if(r||i){const s=Tr(t.visibleWrites,e);if(!i&&Er(s))return n;if(i||null!=n||br(s,le())){const s=function(t){return(t.visible||i)&&(!r||!~r.indexOf(t.writeId))&&(Ce(t.path,e)||Ce(e,t.path))},o=Dr(t.allWrites,s,e),a=n||mn.EMPTY_NODE;return Sr(o,a)}return null}{const r=wr(t.visibleWrites,e);if(null!=r)return r;{const r=Tr(t.visibleWrites,e);if(Er(r))return n;if(null!=n||br(r,le())){const t=n||mn.EMPTY_NODE;return Sr(r,t)}return null}}}function jr(t,e,n){let r=mn.EMPTY_NODE;const i=wr(t.visibleWrites,e);if(i)return i.isLeafNode()||i.forEachChild(an,(t,e)=>{r=r.updateImmediateChild(t,e)}),r;if(n){const i=Tr(t.visibleWrites,e);return n.forEachChild(an,(t,e)=>{const n=Sr(Tr(i,new ue(t)),e);r=r.updateImmediateChild(t,n)}),Cr(i).forEach(t=>{r=r.updateImmediateChild(t.name,t.node)}),r}{const n=Tr(t.visibleWrites,e);return Cr(n).forEach(t=>{r=r.updateImmediateChild(t.name,t.node)}),r}}function Mr(t,e,n,r,i){Object(s["d"])(r||i,"Either existingEventSnap or existingServerSnap must exist");const o=ve(e,n);if(br(t.visibleWrites,o))return null;{const e=Tr(t.visibleWrites,o);return Er(e)?i.getChild(n):Sr(e,i.getChild(n))}}function Fr(t,e,n,r){const i=ve(e,n),s=wr(t.visibleWrites,i);if(null!=s)return s;if(r.isCompleteForChild(n)){const e=Tr(t.visibleWrites,i);return Sr(e,r.getNode().getImmediateChild(n))}return null}function Ur(t,e){return wr(t.visibleWrites,e)}function Vr(t,e,n,r,i,s,o){let a;const c=Tr(t.visibleWrites,e),u=wr(c,le());if(null!=u)a=u;else{if(null==n)return[];a=Sr(c,n)}if(a=a.withIndex(o),a.isEmpty()||a.isLeafNode())return[];{const t=[],e=o.getCompare(),n=s?a.getReverseIteratorFrom(r,o):a.getIteratorFrom(r,o);let c=n.getNext();while(c&&t.length<i)0!==e(c,r)&&t.push(c),c=n.getNext();return t}}function qr(){return{visibleWrites:gr.empty(),allWrites:[],lastWriteId:-1}}function $r(t,e,n,r){return Lr(t.writeTree,t.treePath,e,n,r)}function Br(t,e){return jr(t.writeTree,t.treePath,e)}function zr(t,e,n,r){return Mr(t.writeTree,t.treePath,e,n,r)}function Gr(t,e){return Ur(t.writeTree,ve(t.treePath,e))}function Hr(t,e,n,r,i,s){return Vr(t.writeTree,t.treePath,e,n,r,i,s)}function Wr(t,e,n){return Fr(t.writeTree,t.treePath,e,n)}function Kr(t,e){return Yr(ve(t.treePath,e),t.writeTree)}function Yr(t,e){return{treePath:t,writeTree:e}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xr{getCompleteChild(t){return null}getChildAfterChild(t,e,n){return null}}const Jr=new Xr;class Zr{constructor(t,e,n=null){this.writes_=t,this.viewCache_=e,this.optCompleteServerCache_=n}getCompleteChild(t){const e=this.viewCache_.eventCache;if(e.isCompleteForChild(t))return e.getNode().getImmediateChild(t);{const e=null!=this.optCompleteServerCache_?new nr(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return Wr(this.writes_,t,e)}}getChildAfterChild(t,e,n){const r=null!=this.optCompleteServerCache_?this.optCompleteServerCache_:dr(this.viewCache_),i=Hr(this.writes_,r,e,1,n,t);return 0===i.length?null:i[0]}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ti,Ei;class Si{constructor(){this.views=new Map}}function Ii(t){Object(s["d"])(!Ti,"__referenceConstructor has already been defined"),Ti=t}function ki(){return Object(s["d"])(Ti,"Reference.ts has not been loaded"),Ti}function xi(t){return 0===t.views.size}function Ri(t,e,n,r){const i=e.source.queryId;if(null!==i){const o=t.views.get(i);return Object(s["d"])(null!=o,"SyncTree gave us an op for an invalid query."),bi(o,e,n,r)}{let i=[];for(const s of t.views.values())i=i.concat(bi(s,e,n,r));return i}}function Oi(t,e,n,r,i){const s=e._queryIdentifier,o=t.views.get(s);if(!o){let t=$r(n,i?r:null),s=!1;t?s=!0:r instanceof mn?(t=Br(n,r),s=!1):(t=mn.EMPTY_NODE,s=!1);const o=cr(new nr(t,s,!1),new nr(r,i,!1));return new pi(e,o)}return o}function Ai(t,e,n,r,i,s){const o=Oi(t,e,r,i,s);return t.views.has(e._queryIdentifier)||t.views.set(e._queryIdentifier,o),vi(o,n),wi(o,n)}function Pi(t,e,n,r){const i=e._queryIdentifier,s=[];let o=[];const a=Mi(t);if("default"===i)for(const[c,u]of t.views.entries())o=o.concat(_i(u,n,r)),yi(u)&&(t.views.delete(c),u.query._queryParams.loadsAllData()||s.push(u.query));else{const e=t.views.get(i);e&&(o=o.concat(_i(e,n,r)),yi(e)&&(t.views.delete(i),e.query._queryParams.loadsAllData()||s.push(e.query)))}return a&&!Mi(t)&&s.push(new(ki())(e._repo,e._path)),{removed:s,events:o}}function Ni(t){const e=[];for(const n of t.views.values())n.query._queryParams.loadsAllData()||e.push(n);return e}function Di(t,e){let n=null;for(const r of t.views.values())n=n||gi(r,e);return n}function Li(t,e){const n=e._queryParams;if(n.loadsAllData())return Fi(t);{const n=e._queryIdentifier;return t.views.get(n)}}function ji(t,e){return null!=Li(t,e)}function Mi(t){return null!=Fi(t)}function Fi(t){for(const e of t.views.values())if(e.query._queryParams.loadsAllData())return e;return null}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ts{constructor(t="",e=null,n={children:{},childCount:0}){this.name=t,this.parent=e,this.node=n}}function Es(t,e){let n=e instanceof ue?e:new ue(e),r=t,i=he(n);while(null!==i){const t=Object(s["D"])(r.node.children,i)||{children:{},childCount:0};r=new Ts(i,r,t),n=fe(n),i=he(n)}return r}function Ss(t){return t.node.value}function Is(t,e){t.node.value=e,Ns(t)}function ks(t){return t.node.childCount>0}function xs(t){return void 0===Ss(t)&&!ks(t)}function Rs(t,e){F(t.node.children,(n,r)=>{e(new Ts(n,t,r))})}function Os(t,e,n,r){n&&!r&&e(t),Rs(t,t=>{Os(t,e,!0,r)}),n&&r&&e(t)}function As(t,e,n){let r=n?t:t.parent;while(null!==r){if(e(r))return!0;r=r.parent}return!1}function Ps(t){return new ue(null===t.parent?t.name:Ps(t.parent)+"/"+t.name)}function Ns(t){null!==t.parent&&Ds(t.parent,t.name,t)}function Ds(t,e,n){const r=xs(n),i=Object(s["h"])(t.node.children,e);r&&i?(delete t.node.children[e],t.node.childCount--,Ns(t)):r||i||(t.node.children[e]=n.node,t.node.childCount++,Ns(t))}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ls=/[\[\].#$\/\u0000-\u001F\u007F]/,js=/[\[\].#$\u0000-\u001F\u007F]/,Ms=10485760,Fs=function(t){return"string"===typeof t&&0!==t.length&&!Ls.test(t)},Us=function(t){return"string"===typeof t&&0!==t.length&&!js.test(t)},Vs=function(t){return t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),Us(t)},qs=function(t,e,n,r){r&&void 0===e||$s(Object(s["l"])(t,"value"),e,n)},$s=function(t,e,n){const r=n instanceof ue?new Te(n,t):n;if(void 0===e)throw new Error(t+"contains undefined "+ke(r));if("function"===typeof e)throw new Error(t+"contains a function "+ke(r)+" with contents = "+e.toString());if(R(e))throw new Error(t+"contains "+e.toString()+" "+ke(r));if("string"===typeof e&&e.length>Ms/3&&Object(s["E"])(e)>Ms)throw new Error(t+"contains a string greater than "+Ms+" utf8 bytes "+ke(r)+" ('"+e.substring(0,50)+"...')");if(e&&"object"===typeof e){let n=!1,i=!1;if(F(e,(e,s)=>{if(".value"===e)n=!0;else if(".priority"!==e&&".sv"!==e&&(i=!0,!Fs(e)))throw new Error(t+" contains an invalid key ("+e+") "+ke(r)+'.  Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');Ee(r,e),$s(t,s,r),Se(r)}),n&&i)throw new Error(t+' contains ".value" child '+ke(r)+" in addition to actual children.")}},Bs=function(t,e,n,r){if((!r||void 0!==n)&&!Us(n))throw new Error(Object(s["l"])(t,e)+'was an invalid path = "'+n+'". Paths must be non-empty strings and can\'t contain ".", "#", "$", "[", or "]"')},zs=function(t,e,n,r){n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),Bs(t,e,n,r)},Gs=function(t,e){if(".info"===he(e))throw new Error(t+" failed = Can't modify data under /.info/")},Hs=function(t,e){const n=e.path.toString();if("string"!==typeof e.repoInfo.host||0===e.repoInfo.host.length||!Fs(e.repoInfo.namespace)&&"localhost"!==e.repoInfo.host.split(":")[0]||0!==n.length&&!Vs(n))throw new Error(Object(s["l"])(t,"url")+'must be a valid firebase URL and the path can\'t contain ".", "#", "$", "[", or "]".')};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zs="repo_interrupt",to=25;class eo{constructor(t,e,n,r){this.repoInfo_=t,this.forceRestClient_=e,this.authTokenProvider_=n,this.appCheckProvider_=r,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new Ws,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=Un(),this.transactionQueueTree_=new Ts,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function no(t,e,n){if(t.stats_=gt(t.repoInfo_),t.forceRestClient_||K())t.server_=new Mn(t.repoInfo_,(e,n,r,i)=>{so(t,e,n,r,i)},t.authTokenProvider_,t.appCheckProvider_),setTimeout(()=>oo(t,!0),0);else{if("undefined"!==typeof n&&null!==n){if("object"!==typeof n)throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{Object(s["G"])(n)}catch(r){throw new Error("Invalid authOverride provided: "+r)}}t.persistentConnection_=new Me(t.repoInfo_,e,(e,n,r,i)=>{so(t,e,n,r,i)},e=>{oo(t,e)},e=>{ao(t,e)},t.authTokenProvider_,t.appCheckProvider_,n),t.server_=t.persistentConnection_}t.authTokenProvider_.addTokenChangeListener(e=>{t.server_.refreshAuthToken(e)}),t.appCheckProvider_.addTokenChangeListener(e=>{t.server_.refreshAppCheckToken(e.token)}),t.statsReporter_=yt(t.repoInfo_,()=>new Wn(t.stats_,t.server_)),t.infoData_=new Fn,t.infoSyncTree_=new $i({startListening:(e,n,r,i)=>{let s=[];const o=t.infoData_.getNode(e._path);return o.isEmpty()||(s=Gi(t.infoSyncTree_,e._path,o),setTimeout(()=>{i("ok")},0)),s},stopListening:()=>{}}),co(t,"connected",!1),t.serverSyncTree_=new $i({startListening:(e,n,r,i)=>(t.server_.listen(e,r,n,(n,r)=>{const s=i(n,r);Qs(t.eventQueue_,e._path,s)}),[]),stopListening:(e,n)=>{t.server_.unlisten(e,n)}})}function ro(t){const e=t.infoData_.getNode(new ue(".info/serverTimeOffset")),n=e.val()||0;return(new Date).getTime()+n}function io(t){return gs({timestamp:ro(t)})}function so(t,e,n,r,i){t.dataUpdateCount++;const o=new ue(e);n=t.interceptServerDataCallback_?t.interceptServerDataCallback_(e,n):n;let a=[];if(i)if(r){const e=Object(s["B"])(n,t=>_n(t));a=Xi(t.serverSyncTree_,o,e,i)}else{const e=_n(n);a=Qi(t.serverSyncTree_,o,e,i)}else if(r){const e=Object(s["B"])(n,t=>_n(t));a=Hi(t.serverSyncTree_,o,e)}else{const e=_n(n);a=Gi(t.serverSyncTree_,o,e)}let c=o;a.length>0&&(c=wo(t,o)),Qs(t.eventQueue_,c,a)}function oo(t,e){co(t,"connected",e),!1===e&&ho(t)}function ao(t,e){F(e,(e,n)=>{co(t,e,n)})}function co(t,e,n){const r=new ue("/.info/"+e),i=_n(n);t.infoData_.updateSnapshot(r,i);const s=Gi(t.infoSyncTree_,r,i);Qs(t.eventQueue_,r,s)}function uo(t){return t.nextWriteId_++}function lo(t,e,n,r,i){go(t,"set",{path:e.toString(),value:n,priority:r});const s=io(t),o=_n(n,r),a=Zi(t.serverSyncTree_,e),c=ws(o,a,s),u=uo(t),l=Bi(t.serverSyncTree_,e,c,u,!0);Ks(t.eventQueue_,l),t.server_.put(e.toString(),o.val(!0),(n,r)=>{const s="ok"===n;s||k("set at "+e+" failed: "+n);const o=zi(t.serverSyncTree_,u,!s);Qs(t.eventQueue_,e,o),yo(t,i,n,r)});const h=ko(t,e);wo(t,h),Qs(t.eventQueue_,h,[])}function ho(t){go(t,"onDisconnectEvents");const e=io(t),n=Un();qn(t.onDisconnect_,le(),(r,i)=>{const s=bs(r,i,t.serverSyncTree_,e);Vn(n,r,s)});let r=[];qn(n,le(),(e,n)=>{r=r.concat(Gi(t.serverSyncTree_,e,n));const i=ko(t,e);wo(t,i)}),t.onDisconnect_=Un(),Qs(t.eventQueue_,le(),r)}function fo(t,e,n){let r;r=".info"===he(e._path)?Ji(t.infoSyncTree_,e,n):Ji(t.serverSyncTree_,e,n),Ys(t.eventQueue_,e._path,r)}function po(t,e,n){let r;r=".info"===he(e._path)?Yi(t.infoSyncTree_,e,n):Yi(t.serverSyncTree_,e,n),Ys(t.eventQueue_,e._path,r)}function mo(t){t.persistentConnection_&&t.persistentConnection_.interrupt(Zs)}function go(t,...e){let n="";t.persistentConnection_&&(n=t.persistentConnection_.id+":"),T(n,...e)}function yo(t,e,n,r){e&&W(()=>{if("ok"===n)e(null);else{const t=(n||"error").toUpperCase();let i=t;r&&(i+=": "+r);const s=new Error(i);s.code=t,e(s)}})}function vo(t,e,n){return Zi(t.serverSyncTree_,e,n)||mn.EMPTY_NODE}function _o(t,e=t.transactionQueueTree_){if(e||Io(t,e),Ss(e)){const n=Eo(t,e);Object(s["d"])(n.length>0,"Sending zero length transaction queue");const r=n.every(t=>0===t.status);r&&bo(t,Ps(e),n)}else ks(e)&&Rs(e,e=>{_o(t,e)})}function bo(t,e,n){const r=n.map(t=>t.currentWriteId),i=vo(t,e,r);let o=i;const a=i.hash();for(let l=0;l<n.length;l++){const t=n[l];Object(s["d"])(0===t.status,"tryToSendTransactionQueue_: items in queue should all be run."),t.status=1,t.retryCount++;const r=be(e,t.path);o=o.updateChild(r,t.currentOutputSnapshotRaw)}const c=o.val(!0),u=e;t.server_.put(u.toString(),c,r=>{go(t,"transaction put response",{path:u.toString(),status:r});let i=[];if("ok"===r){const r=[];for(let e=0;e<n.length;e++)n[e].status=2,i=i.concat(zi(t.serverSyncTree_,n[e].currentWriteId)),n[e].onComplete&&r.push(()=>n[e].onComplete(null,!0,n[e].currentOutputSnapshotResolved)),n[e].unwatcher();Io(t,Es(t.transactionQueueTree_,e)),_o(t,t.transactionQueueTree_),Qs(t.eventQueue_,e,i);for(let t=0;t<r.length;t++)W(r[t])}else{if("datastale"===r)for(let t=0;t<n.length;t++)3===n[t].status?n[t].status=4:n[t].status=0;else{k("transaction at "+u.toString()+" failed: "+r);for(let t=0;t<n.length;t++)n[t].status=4,n[t].abortReason=r}wo(t,e)}},a)}function wo(t,e){const n=To(t,e),r=Ps(n),i=Eo(t,n);return Co(t,i,r),r}function Co(t,e,n){if(0===e.length)return;const r=[];let i=[];const o=e.filter(t=>0===t.status),a=o.map(t=>t.currentWriteId);for(let c=0;c<e.length;c++){const o=e[c],u=be(n,o.path);let l,h=!1;if(Object(s["d"])(null!==u,"rerunTransactionsUnderNode_: relativePath should not be null."),4===o.status)h=!0,l=o.abortReason,i=i.concat(zi(t.serverSyncTree_,o.currentWriteId,!0));else if(0===o.status)if(o.retryCount>=to)h=!0,l="maxretry",i=i.concat(zi(t.serverSyncTree_,o.currentWriteId,!0));else{const n=vo(t,o.path,a);o.currentInputSnapshot=n;const r=e[c].update(n.val());if(void 0!==r){$s("transaction failed: Data returned ",r,o.path);let e=_n(r);const c="object"===typeof r&&null!=r&&Object(s["h"])(r,".priority");c||(e=e.updatePriority(n.getPriority()));const u=o.currentWriteId,l=io(t),h=ws(e,n,l);o.currentOutputSnapshotRaw=e,o.currentOutputSnapshotResolved=h,o.currentWriteId=uo(t),a.splice(a.indexOf(u),1),i=i.concat(Bi(t.serverSyncTree_,o.path,h,o.currentWriteId,o.applyLocally)),i=i.concat(zi(t.serverSyncTree_,u,!0))}else h=!0,l="nodata",i=i.concat(zi(t.serverSyncTree_,o.currentWriteId,!0))}Qs(t.eventQueue_,n,i),i=[],h&&(e[c].status=2,function(t){setTimeout(t,Math.floor(0))}(e[c].unwatcher),e[c].onComplete&&("nodata"===l?r.push(()=>e[c].onComplete(null,!1,e[c].currentInputSnapshot)):r.push(()=>e[c].onComplete(new Error(l),!1,null))))}Io(t,t.transactionQueueTree_);for(let s=0;s<r.length;s++)W(r[s]);_o(t,t.transactionQueueTree_)}function To(t,e){let n,r=t.transactionQueueTree_;n=he(e);while(null!==n&&void 0===Ss(r))r=Es(r,n),e=fe(e),n=he(e);return r}function Eo(t,e){const n=[];return So(t,e,n),n.sort((t,e)=>t.order-e.order),n}function So(t,e,n){const r=Ss(e);if(r)for(let i=0;i<r.length;i++)n.push(r[i]);Rs(e,e=>{So(t,e,n)})}function Io(t,e){const n=Ss(e);if(n){let t=0;for(let e=0;e<n.length;e++)2!==n[e].status&&(n[t]=n[e],t++);n.length=t,Is(e,n.length>0?n:void 0)}Rs(e,e=>{Io(t,e)})}function ko(t,e){const n=Ps(To(t,e)),r=Es(t.transactionQueueTree_,e);return As(r,e=>{xo(t,e)}),xo(t,r),Os(r,e=>{xo(t,e)}),n}function xo(t,e){const n=Ss(e);if(n){const r=[];let i=[],o=-1;for(let e=0;e<n.length;e++)3===n[e].status||(1===n[e].status?(Object(s["d"])(o===e-1,"All SENT items should be at beginning of queue."),o=e,n[e].status=3,n[e].abortReason="set"):(Object(s["d"])(0===n[e].status,"Unexpected transaction status in abort"),n[e].unwatcher(),i=i.concat(zi(t.serverSyncTree_,n[e].currentWriteId,!0)),n[e].onComplete&&r.push(n[e].onComplete.bind(null,new Error("set"),!1,null))));-1===o?Is(e,void 0):n.length=o+1,Qs(t.eventQueue_,Ps(e),i);for(let t=0;t<r.length;t++)W(r[t])}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ro(t){let e="";const n=t.split("/");for(let i=0;i<n.length;i++)if(n[i].length>0){let t=n[i];try{t=decodeURIComponent(t.replace(/\+/g," "))}catch(r){}e+="/"+t}return e}function Oo(t){const e={};"?"===t.charAt(0)&&(t=t.substring(1));for(const n of t.split("&")){if(0===n.length)continue;const r=n.split("=");2===r.length?e[decodeURIComponent(r[0])]=decodeURIComponent(r[1]):k(`Invalid query segment '${n}' in query '${t}'`)}return e}const Ao=function(t,e){const n=Po(t),r=n.namespace;"firebase.com"===n.domain&&I(n.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),r&&"undefined"!==r||"localhost"===n.domain||I("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),n.secure||x();const i="ws"===n.scheme||"wss"===n.scheme;return{repoInfo:new lt(n.host,n.secure,r,e,i,"",r!==n.subdomain),path:new ue(n.pathString)}},Po=function(t){let e="",n="",r="",i="",s="",o=!0,a="https",c=443;if("string"===typeof t){let u=t.indexOf("//");u>=0&&(a=t.substring(0,u-1),t=t.substring(u+2));let l=t.indexOf("/");-1===l&&(l=t.length);let h=t.indexOf("?");-1===h&&(h=t.length),e=t.substring(0,Math.min(l,h)),l<h&&(i=Ro(t.substring(l,h)));const d=Oo(t.substring(Math.min(t.length,h)));u=e.indexOf(":"),u>=0?(o="https"===a||"wss"===a,c=parseInt(e.substring(u+1),10)):u=e.length;const f=e.slice(0,u);if("localhost"===f.toLowerCase())n="localhost";else if(f.split(".").length<=2)n=f;else{const t=e.indexOf(".");r=e.substring(0,t).toLowerCase(),n=e.substring(t+1),s=r}"ns"in d&&(s=d["ns"])}return{host:e,port:c,domain:n,subdomain:r,secure:o,scheme:a,pathString:i,namespace:s}};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class jo{constructor(t,e,n,r){this._repo=t,this._path=e,this._queryParams=n,this._orderByCalled=r}get key(){return _e(this._path)?null:pe(this._path)}get ref(){return new Mo(this._repo,this._path)}get _queryIdentifier(){const t=jn(this._queryParams),e=j(t);return"{}"===e?"default":e}get _queryObject(){return jn(this._queryParams)}isEqual(t){if(t=Object(s["m"])(t),!(t instanceof jo))return!1;const e=this._repo===t._repo,n=we(this._path,t._path),r=this._queryIdentifier===t._queryIdentifier;return e&&n&&r}toJSON(){return this.toString()}toString(){return this._repo.toString()+me(this._path)}}class Mo extends jo{constructor(t,e){super(t,e,new Nn,!1)}get parent(){const t=ye(this._path);return null===t?null:new Mo(this._repo,t)}get root(){let t=this;while(null!==t.parent)t=t.parent;return t}}class Fo{constructor(t,e,n){this._node=t,this.ref=e,this._index=n}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(t){const e=new ue(t),n=Vo(this.ref,t);return new Fo(this._node.getChild(e),n,an)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(t){if(this._node.isLeafNode())return!1;const e=this._node;return!!e.forEachChild(this._index,(e,n)=>t(new Fo(n,Vo(this.ref,e),an)))}hasChild(t){const e=new ue(t);return!this._node.getChild(e).isEmpty()}hasChildren(){return!this._node.isLeafNode()&&!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function Uo(t,e){return t=Object(s["m"])(t),t._checkNotDeleted("ref"),void 0!==e?Vo(t._root,e):t._root}function Vo(t,e){return t=Object(s["m"])(t),null===he(t._path)?zs("child","path",e,!1):Bs("child","path",e,!1),new Mo(t._repo,ve(t._path,e))}function qo(t,e){t=Object(s["m"])(t),Gs("push",t._path),qs("push",e,t._path,!0);const n=ro(t._repo),r=En(n),i=Vo(t,r),o=Vo(t,r);let a;return a=null!=e?$o(o,e).then(()=>o):Promise.resolve(o),i.then=a.then.bind(a),i.catch=a.then.bind(a,void 0),i}function $o(t,e){t=Object(s["m"])(t),Gs("set",t._path),qs("set",e,t._path,!1);const n=new s["a"];return lo(t._repo,t._path,e,null,n.wrapCallback(()=>{})),n.promise}class Bo{constructor(t){this.callbackContext=t}respondsTo(t){return"value"===t}createEvent(t,e){const n=e._queryParams.getIndex();return new No("value",this,new Fo(t.snapshotNode,new Mo(e._repo,e._path),n))}getEventRunner(t){return"cancel"===t.getEventType()?()=>this.callbackContext.onCancel(t.error):()=>this.callbackContext.onValue(t.snapshot,null)}createCancelEvent(t,e){return this.callbackContext.hasCancelCallback?new Do(this,t,e):null}matches(t){return t instanceof Bo&&(!t.callbackContext||!this.callbackContext||t.callbackContext.matches(this.callbackContext))}hasAnyCallback(){return null!==this.callbackContext}}class zo{constructor(t,e){this.eventType=t,this.callbackContext=e}respondsTo(t){let e="children_added"===t?"child_added":t;return e="children_removed"===e?"child_removed":e,this.eventType===e}createCancelEvent(t,e){return this.callbackContext.hasCancelCallback?new Do(this,t,e):null}createEvent(t,e){Object(s["d"])(null!=t.childName,"Child events should have a childName.");const n=Vo(new Mo(e._repo,e._path),t.childName),r=e._queryParams.getIndex();return new No(t.type,this,new Fo(t.snapshotNode,n,r),t.prevName)}getEventRunner(t){return"cancel"===t.getEventType()?()=>this.callbackContext.onCancel(t.error):()=>this.callbackContext.onValue(t.snapshot,t.prevName)}matches(t){return t instanceof zo&&(this.eventType===t.eventType&&(!this.callbackContext||!t.callbackContext||this.callbackContext.matches(t.callbackContext)))}hasAnyCallback(){return!!this.callbackContext}}function Go(t,e,n,r,i){let s;if("object"===typeof r&&(s=void 0,i=r),"function"===typeof r&&(s=r),i&&i.onlyOnce){const e=n,r=(n,r)=>{po(t._repo,t,a),e(n,r)};r.userCallback=n.userCallback,r.context=n.context,n=r}const o=new Lo(n,s||void 0),a="value"===e?new Bo(o):new zo(e,o);return fo(t._repo,t,a),()=>po(t._repo,t,a)}function Ho(t,e,n,r){return Go(t,"value",e,n,r)}Ii(Mo),Ui(Mo);
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const Wo="FIREBASE_DATABASE_EMULATOR_HOST",Ko={};let Yo=!1;function Qo(e,n,r,i,s){let o=i||e.options.databaseURL;void 0===o&&(e.options.projectId||I("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),T("Using default host for project ",e.options.projectId),o=e.options.projectId+"-default-rtdb.firebaseio.com");let a,c=Ao(o,s),u=c.repoInfo,l=void 0;"undefined"!==typeof t&&(l=Object({NODE_ENV:"production",BASE_URL:""})[Wo]),l?(a=!0,o=`http://${l}?ns=${u.namespace}`,c=Ao(o,s),u=c.repoInfo):a=!c.repoInfo.secure;const h=s&&a?new J(J.OWNER):new X(e.name,e.options,n);Hs("Invalid Firebase Database URL",c),_e(c.path)||I("Database URL must point to the root of a Firebase Database (not including a child path).");const d=Jo(u,e,h,new Q(e.name,r));return new Zo(d,e)}function Xo(t,e){const n=Ko[e];n&&n[t.key]===t||I(`Database ${e}(${t.repoInfo_}) has already been deleted.`),mo(t),delete n[t.key]}function Jo(t,e,n,r){let i=Ko[e.name];i||(i={},Ko[e.name]=i);let s=i[t.toURLString()];return s&&I("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),s=new eo(t,Yo,n,r),i[t.toURLString()]=s,s}class Zo{constructor(t,e){this._repoInternal=t,this.app=e,this["type"]="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(no(this._repoInternal,this.app.options.appId,this.app.options["databaseAuthVariableOverride"]),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Mo(this._repo,le())),this._rootInternal}_delete(){return null!==this._rootInternal&&(Xo(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(t){null===this._rootInternal&&I("Cannot call "+t+" on a deleted database.")}}function ta(t=Object(r["e"])(),e){return Object(r["b"])(t,"database").getImmediate({identifier:e})}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
class o{constructor(t){this.container=t}getPlatformInfoString(){const t=this.container.getProviders();return t.map(t=>{if(a(t)){const e=t.getImmediate();return`${e.library}/${e.version}`}return null}).filter(t=>t).join(" ")}}function a(t){const e=t.getComponent();return"VERSION"===(null===e||void 0===e?void 0:e.type)}const c="@firebase/app",u="0.7.4",l=new i["b"]("@firebase/app"),h="@firebase/app-compat",d="@firebase/analytics-compat",f="@firebase/analytics",p="@firebase/app-check-compat",m="@firebase/app-check",g="@firebase/auth",y="@firebase/auth-compat",v="@firebase/database",_="@firebase/database-compat",b="@firebase/functions",w="@firebase/functions-compat",C="@firebase/installations",T="@firebase/installations-compat",E="@firebase/messaging",S="@firebase/messaging-compat",I="@firebase/performance",k="@firebase/performance-compat",x="@firebase/remote-config",R="@firebase/remote-config-compat",O="@firebase/storage",A="@firebase/storage-compat",P="@firebase/firestore",N="@firebase/firestore-compat",D="firebase",L="9.1.3",j="[DEFAULT]",M={[c]:"fire-core",[h]:"fire-core-compat",[f]:"fire-analytics",[d]:"fire-analytics-compat",[m]:"fire-app-check",[p]:"fire-app-check-compat",[g]:"fire-auth",[y]:"fire-auth-compat",[v]:"fire-rtdb",[_]:"fire-rtdb-compat",[b]:"fire-fn",[w]:"fire-fn-compat",[C]:"fire-iid",[T]:"fire-iid-compat",[E]:"fire-fcm",[S]:"fire-fcm-compat",[I]:"fire-perf",[k]:"fire-perf-compat",[x]:"fire-rc",[R]:"fire-rc-compat",[O]:"fire-gcs",[A]:"fire-gcs-compat",[P]:"fire-fst",[N]:"fire-fst-compat","fire-js":"fire-js",[D]:"fire-js-all"},F=new Map,U=new Map;function V(t,e){try{t.container.addComponent(e)}catch(n){l.debug(`Component ${e.name} failed to register with FirebaseApp ${t.name}`,n)}}function q(t){const e=t.name;if(U.has(e))return l.debug(`There were multiple attempts to register component ${e}.`),!1;U.set(e,t);for(const n of F.values())V(n,t);return!0}function $(t,e){return t.container.getProvider(e)}function B(t,e,n=j){$(t,e).clearInstance(n)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const W=L;function K(t,e={}){if("object"!==typeof e){const t=e;e={name:t}}const n=Object.assign({name:j,automaticDataCollectionEnabled:!1},e),i=n.name;if("string"!==typeof i||!i)throw G.create("bad-app-name",{appName:String(i)});const o=F.get(i);if(o){if(Object(s["k"])(t,o.options)&&Object(s["k"])(n,o.config))return o;throw G.create("duplicate-app",{appName:i})}const a=new r["b"](i);for(const r of U.values())a.addComponent(r);const c=new H(t,n,a);return F.set(i,c),c}function Y(t=j){const e=F.get(t);if(!e)throw G.create("no-app",{appName:t});return e}function Q(t,e,n){var i;let s=null!==(i=M[t])&&void 0!==i?i:t;n&&(s+="-"+n);const o=s.match(/\s|\//),a=e.match(/\s|\//);if(o||a){const t=[`Unable to register library "${s}" with version "${e}":`];return o&&t.push(`library name "${s}" contains illegal characters (whitespace or "/")`),o&&a&&t.push("and"),a&&t.push(`version name "${e}" contains illegal characters (whitespace or "/")`),void l.warn(t.join(" "))}q(new r["a"](s+"-version",()=>({library:s,version:e}),"VERSION"))}
/**
 * @license
 * Copyright 2019 Google LLC
 *
